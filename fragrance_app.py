...
def clean_display_text(s) -> str:
    """Strip mojibake / weird separators so mobile text stays readable."""
    if s is None:
        return ""
    t = str(s)
    replacements = [
...
if "fragrances_db" not in st.session_state:
    # Prefer largest available vault: disk -> session path already empty -> embedded seed
    _disk_db = list((_persisted.get("fragrances_db") or []))
    _seed_db = [{"name": "8th Wonder", "brand": "French Avenue", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Cardamom, Pink Pepper, Candy Apple / Heart - Liquor, Dates, Boozy notes, Davana, Osmanthus / Base - Myrrh, Benzoin, Styrax, Amber Xtreme, Labdanum, Patchouli", "category": ["Oriental", "Spicy", "Sweet", "Boozy", "Chypre", "Woody"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Ajwad", "brand": "Lattafa", "gender": "Unisex", "season": "Versatile (cooler preferred)", "notes": "Fruity-woody-oriental (pineapple/rose/oud-leaning)", "category": ["Oriental", "Woody", "Fruity", "Floral", "Oud"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Angham", "brand": "Lattafa", "gender": "Unisex (leans feminine)", "season": "Fall, Winter", "notes": "Top - Ginger, Mandarin, Pink Pepper / Heart - Lavender, Praline, Cacao, Jasmine / Base - Vanilla, Amber, Musk", "category": ["Gourmand", "Spicy", "Sweet", "Aromatic", "Citrus"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Ansaam Gold", "brand": "Lattafa", "gender": "Female/Unisex", "season": "Fall, Winter", "notes": "Top - Mandarin Orange, Pear / Heart - Sweet Notes, Jasmine, Rose / Base - Musk, Vanilla, Raspberry", "category": ["Fruity", "Floral", "Sweet", "Citrus", "Gourmand"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Asad", "brand": "Lattafa", "gender": "Male", "season": "Fall, Winter", "notes": "Top - Black Pepper, Tobacco, Pineapple / Heart - Patchouli, Coffee, Iris / Base - Vanilla, Amber, Dry Woods, Benzoin, Labdanum", "category": ["Woody", "Spicy", "Oriental", "Gourmand", "Fruity", "Chypre"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Badee Al Oud Noble Blush", "brand": "Lattafa", "gender": "Female", "season": "Fall, Winter", "notes": "Top - Rose Milk / Heart - Meringue, Almond / Base - Vanilla, Musk, Sandalwood", "category": ["Floral", "Gourmand", "Sweet", "Creamy", "Woody", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Bahiya Garnet", "brand": "Arabiyat Prestige", "gender": "Female-leaning", "season": "Fall, Winter", "notes": "Top - Cherry, Mandarin, Mango, Pear, Bergamot / Heart - Amber, Fig, Jasmine / Base - Amber, Vanilla, Sandalwood, Musk", "category": ["Fruity", "Oriental", "Sweet", "Citrus", "Woody", "Chypre", "Creamy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Banat Dubai", "brand": "Le Chameau", "gender": "Female", "season": "Spring, fall", "notes": "Top - Jasmine, Bergamot, Peony / Heart - Pineapple, Peach, Plum / Base - Musk, Patchouli, Sandalwood", "category": ["Floral", "Fruity", "Woody", "Citrus", "Chypre"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Berries Cream Macaron", "brand": "Arabiyat Sugar", "gender": "Female", "season": "Spring-Fall", "notes": "Top Notes: Juicy lycheeHeart (Middle) Notes: Raspberry, maltol (confectionary sweetness), and jasmineBase Notes: Ambroxan, ambergris (or dry amber), and evernyl", "category": ["Gourmand", "Fruity", "Sweet", "Amber", "Floral", "Oriental"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Bint Hooran", "brand": "Ard Al Zaafaran", "gender": "Female", "season": "Fall, Winter", "notes": "Top - Almond, Coffee, Ylang Ylang / Heart - Jasmine, Rose, Tuberose / Base - Vanilla, Musk, Tonka, Woody/Cacao", "category": ["Gourmand", "Floral", "Oriental", "Sweet", "Vanilla", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Boulevard of New York", "brand": "Le Chameau", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Roasted Coffee Beans / Heart - Praline, Rose / Base - Oakmoss, Cedar, Amber", "category": ["Gourmand", "Woody", "Chypre", "Fougere", "Sweet"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Cafe Bliss", "brand": "Mamlakat Al Oud", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Black Coffee, Amaretto Liquor / Heart - Vanilla Ice Cream, Speculoos / Base - Vanilla Pods, Brown Sugar, Grey Amber", "category": ["Gourmand", "Sweet", "Boozy", "Vanilla", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Cafe Latte", "brand": "Khadlaj", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Coffee, Sweet Almond, Milk / Heart - Vanilla, Ice Cream Accord, Amber / Base - Vanilla, Almond Cream, Caramel", "category": ["Gourmand", "Sweet", "Creamy", "Vanilla", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Caramel Chocolate Macaron", "brand": "Arabiyat Sugar", "gender": "Female/Unisex", "season": "Fall-Winter", "notes": "Top Notes: Caramel, Coumarin (providing a sweet, warm, almond-vanilla nuance)Middle / Heart Notes: Honey, Soft Floral NotesBase Notes: Musk", "category": ["Gourmand", "Sweet", "Fougere", "Vanilla", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Caramello", "brand": "Al Rehab", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Pistachio, Almond / Heart - Jasmine, Heliotrope / Base - Caramel, Vanilla, Sandalwood", "category": ["Gourmand", "Sweet", "Floral", "Woody", "Creamy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Chocomusk", "brand": "Al Rehab", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Warm Spicy, Amber / Heart - Sweet, Powdery, Vanilla / Base - Chocolate, Musky, Cocoa", "category": ["Gourmand", "Sweet", "Powdery", "Musky", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Chocomusk Marshmallow", "brand": "Al Rehab", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Marshmallow, Strawberry / Heart - Cocoa, Vanilla / Base - Sweet Musk", "category": ["Gourmand", "Sweet", "Fruity", "Vanilla", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Chocomusk Vanilla", "brand": "Al Rehab", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Chocolate / Heart - Vanilla / Base - Musk", "category": ["Gourmand", "Sweet", "Vanilla", "Animalic", "Musky"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Club De Nuit Women", "brand": "Armaf", "gender": "Female", "season": "Spring, Fall", "notes": "Top - Apple, Citrus / Heart - Rose, Jasmine / Base - Vanilla, Musk", "category": ["Floral", "Fruity", "Fresh", "Citrus", "Gourmand", "Sweet", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Coconut Chiffon", "brand": "Arabiyat Sugar", "gender": "Female/Unisex", "season": "Spring-Summer", "notes": "Top Notes: CoconutMiddle (Heart) Notes: Coconut, JasmineBase Notes: Vanilla, Butter, Cooked Sugar (Caramel), Musk", "category": ["Gourmand", "Sweet", "Fresh", "Creamy", "Floral", "Fruity"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Confections", "brand": "Paris Corner", "gender": "Female/Unisex", "season": "Fall-Winter", "notes": "Top Notes: Pear and Whipped CreamHeart (Middle) Notes: Cashmeran, Jasmine, and Ylang-YlangBase Notes: Marshmallow, Vanilla, and Sandalwood", "category": ["Gourmand", "Sweet", "Creamy", "Floral", "Woody"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Cookie Bite", "brand": "Gulf Orchid", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Cookie, Butter / Heart - Vanilla, Musk / Base - Caramel, Amber", "category": ["Gourmand", "Sweet", "Creamy", "Vanilla", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Coral (Ana Abiyedh Coral)", "brand": "Lattafa", "gender": "Unisex (leans feminine)", "season": "Spring, Summer", "notes": "Top - Watermelon, Peach, Orange / Heart - Coconut, White Flowers / Base - Musk, Vanilla, Amber", "category": ["Fruity", "Fresh", "Sweet", "Citrus", "Gourmand", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Cotton Blush", "brand": "Arabiyat Sugar", "gender": "Female", "season": "Spring, summer", "notes": "Top Notes: Strawberry, Raspberry, CoconutHeart (Middle) Notes: Marshmallow, Peony, RoseBase Notes: Vanilla, Amber, Musk", "category": ["Floral", "Fruity", "Gourmand", "Sweet", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Cotton Candy Delicacy", "brand": "Armaf", "gender": "Unisex", "season": "Spring, Summer", "notes": "Top Notes: Raspberry, Pink Pepper, and CocoaHeart (Middle) Notes: Jasmine and RoseBase Notes: Vanilla, Benzoin Resinoid, and Cedarwood", "category": ["Gourmand", "Fruity", "Floral", "Oriental", "Spicy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Cream Velvet", "brand": "Khadlaj", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top Notes: Creamy Butter and Golden CaramelMiddle (Heart) Notes: Honey, Tonka Bean, and JasmineBase Notes: Smooth Vanilla, Amber, and Soft Musk", "category": ["Gourmand", "Sweet", "Floral", "Creamy", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Creme of Clouds", "brand": "Fragrance World", "gender": "Unisex", "season": "Fall, Winter, spring", "notes": "Top Notes: Coconut milk, Creamy milk, Burnt sugarHeart (Middle) Notes: Whipped cream, Vanilla, ChocolateBase Notes: Vanilla, White musk, Burnt sugar", "category": ["Gourmand", "Sweet", "Creamy", "Fruity", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Creme Caramel", "brand": "Mamlakat Al Oud", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Caramel, Vanilla Flower / Heart - Dulce de Leche, Cotton Candy, Frangipani, White Flowers / Base - Vanilla Pod, Tonka Bean, Musk", "category": ["Gourmand", "Sweet", "Vanilla", "Animalic", "Musky"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Cup Cake", "brand": "Al Rehab", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Citrus, Amber / Heart - Vanilla Cake / Base - Vanilla, Amber", "category": ["Gourmand", "Sweet", "Citrus", "Vanilla", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Dalal", "brand": "Lattafa", "gender": "Female", "season": "Spring", "notes": "Top - Apple (Golden Delicious), Mandarin / Heart - Jasmine, Ylang-Ylang, Orange Flower / Base - Vanilla, Musk, Oakmoss", "category": ["Floral", "Fruity", "Fresh", "Citrus", "Chypre", "Fougere", "Gourmand"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Dulzura", "brand": "Paris Corner", "gender": "Female", "season": "Fall-Winter", "notes": "Top - Black pepper, buttermilk / Heart - Cake, vanilla, cream / Base - Amber, musk", "category": ["Gourmand", "Sweet", "Creamy", "Spicy", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Eclaire", "brand": "Lattafa", "gender": "Female", "season": "Fall, Winter", "notes": "Top - Caramel, Milk, Sugar / Heart - Honey, White Flowers / Base - Vanilla, Praline, Musk", "category": ["Gourmand", "Sweet", "Vanilla", "Animalic", "Creamy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Eclaire Banoffi", "brand": "Lattafa", "gender": "Unisex/Female", "season": "Fall-Winter", "notes": "Top Notes: Banana Cream, Dulce de LecheHeart (Middle) Notes: Whipped Cream, VanillaBase Notes: Praline, Biscuit, Musk", "category": ["Gourmand", "Sweet", "Fruity", "Vanilla", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Elyssia Aura", "brand": "Riiffs", "gender": "Unisex", "season": "Fall, Winter (versatile to cooler)", "notes": "Top - Cinnamon, Orange, Nutmeg / Heart - Vanilla Cream, Cognac, Cocoa / Base - Bourbon Vanilla, Cedarwood, Patchouli", "category": ["Gourmand", "Spicy", "Woody", "Boozy", "Citrus"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Elyssia Scarlet", "brand": "Riiffs", "gender": "Female", "season": "Spring-Summer / versatile", "notes": "Top - Black Cherry, Pink Pepper / Heart - Leather, Cream, Benzoin / Base - Vanilla Absolute, Cashmeran, Amber, Iso E Super", "category": ["Fruity", "Leather", "Sweet", "Gourmand", "Oriental", "Spicy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Emaan", "brand": "Lattafa", "gender": "Female/Unisex", "season": "Fall, Winter", "notes": "Top - Orange Blossom, Black Currant, Bergamot / Heart - Tuberose, Jasmine, Marigold / Base - Musk, Vanilla, Cedarwood, Patchouli", "category": ["Floral", "Fruity", "Citrus", "Woody", "Chypre", "Gourmand"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Emir Pear Potion", "brand": "Paris Corner", "gender": "Unisex", "season": "Spring", "notes": "Top - Pear, Apple / Heart - Caramel, Jasmine / Base - Raspberry, Musk", "category": ["Fruity", "Gourmand", "Sweet", "Floral", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Empire Najm by Risala", "brand": "Risala", "gender": "Unisex (female-leaning)", "season": "Fall, Winter", "notes": "Top - Mango, Ginger, Lemon, Red Berries / Heart - Coumarin, Jasmine, Cedar / Base - Cypriol, Amber, Musk, Oud", "category": ["Fruity", "Oriental", "Woody", "Floral", "Fougere", "Spicy", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Empire Victor", "brand": "Khadlaj", "gender": "Unisex", "season": "Fall, Winter,spring", "notes": "Top Notes: Lemon, BergamotMiddle (Heart) Notes: Caramel, JasmineBase Notes: Vanilla, Musk (some variations also list sandalwood)", "category": ["Gourmand", "Floral", "Fruity", "Sweet", "Citrus", "Woody", "Chypre"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Energize", "brand": "Heroes", "gender": "Male", "season": "Spring, Summer", "notes": "Top - Citrus, Aromatic Herbs / Heart - Light Spices / Base - Woods, Musk", "category": ["Fresh", "Citrus", "Aromatic", "Animalic", "Musky", "Spicy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Entice Extrait", "brand": "Vurv", "gender": "Female", "season": "Cooler / evening", "notes": "Top Notes: Citrus and fresh floral elements (including aromatic nuances like lilac and bergamot)Heart / Middle Notes: Rich bouquet of floral accordsBase Notes: Warm amber, sensual musk, and woody elements", "category": ["Oriental", "Sweet", "Fruity", "Citrus", "Aromatic", "Chypre", "Amber", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Entice Ruby", "brand": "Vurv", "gender": "Female", "season": "Spring-Summer / versatile", "notes": "Top Notes: Red fruits, Bergamot, MandarinHeart (Middle) Notes: Roses, Jasmine, White flowersBase Notes: Amber, Musk, Soft woods, Vanilla", "category": ["Fruity", "Floral", "Citrus", "Chypre", "Gourmand", "Sweet"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Eshal Vanilla", "brand": "Paris Corner", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top Notes: Sugar, Sweet NotesHeart (Middle) Notes: Jasmine, RoseBase Notes: Vanilla, Caramel, Musk", "category": ["Gourmand", "Floral", "Sweet", "Vanilla", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Espada Intense", "brand": "Le Chameau", "gender": "Male", "season": "Cooler seasons / evening", "notes": "Deeper/intensified version of Espada Prime", "category": ["Woody", "Spicy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Espada Prime", "brand": "Le Chameau", "gender": "Male", "season": "Spring-Summer / versatile", "notes": "Top Notes (Head): Ruby, mandarin orange, grapefruit, and peppermint (mint)Middle Notes (Heart): Rose absolute, cinnamon, and mixed spicesBase Notes: Leather, patchouli, whitewoods, and amber", "category": ["Fresh", "Woody", "Spicy", "Citrus", "Leather", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Essences", "brand": "Sara Debai", "gender": "Female", "season": "Spring-Summer", "notes": "Top - Heliotrope, orchid, tangerine / Heart - Gourmand accord, tropical fruits / Base - Vanilla, musk, sandalwood", "category": ["Floral", "Gourmand", "Fruity", "Woody", "Creamy", "Powdery"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Eternal Vanille", "brand": "Lattafa", "gender": "Unisex", "season": "Year-round (best Spring/Fall)", "notes": "Top - Blackberry / Heart - Cocoapulse, Vanilla Caviar, Cacao / Base - Akigalawood, Tonka Bean, Ambrofix, Cedarwood, Benzoin, Musk", "category": ["Gourmand", "Woody", "Sweet", "Oriental", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Fakhama", "brand": "Amaran", "gender": "Unisex/Male", "season": "Cooler seasons", "notes": "Top Notes: Cinnamon, nutmeg, and vanillaMiddle (Heart) Notes: Dates, tuberose, praline, and mahonialBase Notes: Musk, tonka bean, amberwood, myrrh, benzoin, and akigalawood", "category": ["Oriental", "Woody", "Gourmand", "Spicy", "Sweet", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Fakhar Black", "brand": "Lattafa", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Dark Fruits, Spices / Heart - Woody / Base - Vanilla, Musk", "category": ["Fruity", "Woody", "Spicy", "Gourmand", "Sweet", "Vanilla", "Animalic", "Musky"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Fakhar Gold", "brand": "Lattafa", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Tuberose, Salt / Heart - Amber, Tonka / Base - Cedarwood, Vetiver, Labdanum", "category": ["Floral", "Woody", "Oriental", "Chypre", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Fakhar Silver", "brand": "Lattafa", "gender": "Unisex", "season": "Spring , summer", "notes": "Top Notes: Apple, Bergamot, GingerHeart (Middle) Notes: Lavender, Sage, Juniper Berries, GeraniumBase Notes: Tonka Bean, Amberwood, Cedar, Vetiver", "category": ["Gourmand", "Woody", "Aromatic", "Citrus", "Amber", "Chypre"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Falak", "brand": "Nusuk", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Brown Sugar, Caramel, Biscuit / Heart - Toffee, Vanilla Bean, Amber / Base - White Musk, Praline", "category": ["Gourmand", "Sweet", "Vanilla", "Amber", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Fatima Pink", "brand": "Zimaya", "gender": "Female", "season": "Spring, Fall", "notes": "Top - Rhubarb, Bergamot, Grapefruit, Nutmeg / Heart - Rose, Jasmine / Base - Musk, Vanilla, Vetiver, Ambergris", "category": ["Floral", "Fruity", "Fresh", "Citrus", "Amber", "Chypre", "Gourmand"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Fire on Ice", "brand": "Lattafa", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top Notes: Black raspberry, cinnamon, cognac (liquor)Middle (Heart) Notes: Frozen rose petals, caramel, mossBase Notes: Oakwood, myrrh, cedarwood, ambroxan", "category": ["Gourmand", "Boozy", "Fruity", "Woody", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "French Vanilla", "brand": "Al Rehab", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Vanilla / Heart - Creamy Sweet / Base - Vanilla, Musk", "category": ["Gourmand", "Sweet", "Creamy", "Vanilla", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "French Vanilla Latte", "brand": "Arabiyat Sugar", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Nutella, Cardamom, Rum / Heart - Cocoa, Coconut, White Flowers, Lily of the Valley / Base - Sandalwood, Ambergris, Musk", "category": ["Gourmand", "Sweet", "Amber", "Woody", "Creamy", "Fruity", "Spicy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Ghaliya", "brand": "Zakat", "gender": "Unisex/Female", "season": "Fall-Winter", "notes": "Top Notes: Orange, Lemon, Apple, and BergamotMiddle (Heart) Notes: Caramel, Muguet (Lily of the Valley), Cedarwood, Jasmine Sambac, Bulgarian Rose, and TuberoseBase Notes: Tonka Bean, Amber, Musk, Cocoa, Sandalwood, and Patchouli", "category": ["Oriental", "Floral", "Oud", "Woody", "Citrus", "Gourmand", "Chypre"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Ghubar Al Dhahab", "brand": "Sahari", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Cinnamon, Pear, Mandarin, Floral notes / Heart - Jasmine Sambac, Orange Blossom / Base - White Musk, Vanilla, Tonka Bean, Coffee, Patchouli", "category": ["Floral", "Spicy", "Sweet", "Citrus", "Gourmand"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Habik (Women's Version)", "brand": "Lattafa", "gender": "Female", "season": "Spring, Summer", "notes": "Top - Pear, Bergamot / Heart - Lily of the Valley, Jasmine, Freesia / Base - Musk, Amber, Oakmoss", "category": ["Floral", "Fresh", "Fruity", "Chypre", "Citrus", "Fougere", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Hareem Al Sultan Gold", "brand": "Khadlaj", "gender": "Female", "season": "Spring, Summer", "notes": "Top - Bergamot, Jasmine, Peony / Heart - Pineapple, Peach, Plum / Base - Musk, Sandalwood, Patchouli", "category": ["Floral", "Fruity", "Fresh", "Woody", "Chypre", "Citrus"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Hawas Diva", "brand": "Rasasi", "gender": "Female", "season": "Fall, Winter", "notes": "Top - Red Fruits, Rhubarb, Lychee / Heart - Rose, Frankincense, Cedar / Base - Vanilla, Musk, Ambergris", "category": ["Fruity", "Floral", "Woody", "Amber", "Oriental", "Gourmand", "Smoky"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Hawas Eclat (Eclat Hawas)", "brand": "Rasasi", "gender": "Female", "season": "Spring, Fall", "notes": "Top - Litchi/Lychee, Bergamot, Pear, Pistachio / Heart - Rose, Incense / Base - Vanilla, Amber, Musk, Woody Notes", "category": ["Fruity", "Floral", "Woody", "Gourmand", "Oriental", "Chypre", "Citrus"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Hawas Elixir", "brand": "Rasasi", "gender": "Unisex", "season": "Fall-Winter", "notes": "Top - Mint, bergamot, artemisia / Heart - Dark chocolate, lavender, benzoin / Base - Vanilla, tonka bean, white musk", "category": ["Gourmand", "Fresh", "Sweet", "Aromatic", "Chypre", "Citrus", "Fougere"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Hawas Ice", "brand": "Rasasi", "gender": "Male", "season": "Spring , summer", "notes": "Top - Apple, Italian Lemon, Sicilian Bergamot, Star Anise / Heart - Plum, Orange Blossom, Cardamom / Base - Musk, Moss, Driftwood, Amber", "category": ["Fresh", "Fruity", "Aromatic", "Citrus", "Floral", "Spicy", "Chypre"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Hawas London", "brand": "Rasasi", "gender": "Unisex", "season": "Fall, Spring", "notes": "Top - Pink Pepper, Saffron, Pear / Heart - Rose, Frankincense, White Flowers / Base - Blonde Woods, Vanilla, Amber, Musk", "category": ["Floral", "Woody", "Spicy", "Oriental", "Gourmand", "Smoky", "Sweet"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Hawas Pink", "brand": "Rasasi", "gender": "Female", "season": "Fall, Winter", "notes": "Top - Cinnamon, Nutmeg, Neroli / Heart - Marshmallow, Tuberose, Orange Blossom / Base - Cotton Candy, Vanilla, Tonka Bean", "category": ["Gourmand", "Floral", "Sweet", "Citrus", "Spicy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Hawwa Red", "brand": "Zimaya", "gender": "Female", "season": "Fall, Winter", "notes": "Top - Cassis, Strawberry, Raspberry, Orange / Heart - Black Currant, Grapefruit, Peach, Lily / Base - Musk, Vanilla, Patchouli", "category": ["Fruity", "Floral", "Sweet", "Citrus", "Gourmand", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Haya", "brand": "Lattafa", "gender": "Female", "season": "Fall, Winter", "notes": "Top - Champagne, Strawberry, Rose, Tangerine, Blood Orange / Heart - Gardenia, Jasmine, Vanilla Orchid / Base - Amber, Sandalwood", "category": ["Floral", "Fruity", "Sweet", "Woody", "Boozy", "Citrus"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Heavy Cream", "brand": "Phlur", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Marshmallow, Sugar, Citrus / Heart - Coconut, Jasmine / Base - Whipped Cream, Vanilla, Caramel", "category": ["Gourmand", "Sweet", "Citrus", "Floral", "Fruity"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Her Confessions", "brand": "Lattafa", "gender": "Female", "season": "Fall, Winter", "notes": "Top - Cinnamon / Heart - Tuberose, Jasmine, Incense / Base - Vanilla, Musk, Tonka", "category": ["Floral", "Spicy", "Oriental", "Gourmand", "Smoky"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "His Confessions", "brand": "Lattafa", "gender": "Male", "season": "Fall, Winter", "notes": "Top - Lavender, Cinnamon, Mandarin / Heart - Iris, Benzoin, Cypress, Mahonial / Base - Vanilla, Tonka, Amber, Incense, Cedarwood, Patchouli", "category": ["Woody", "Spicy", "Oriental", "Aromatic", "Citrus", "Fougere"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Island Bliss", "brand": "Armaf", "gender": "Unisex", "season": "Spring, Summer", "notes": "Top - Tropical Fruits, Coconut / Heart - Sweet / Base - Musk", "category": ["Fruity", "Fresh", "Sweet", "Animalic", "Musky"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Khair Men", "brand": "Paris Corner", "gender": "Male/Unisex", "season": "Fall, Winter", "notes": "Top - Davana, Bergamot, Pink Pepper / Heart - Agarwood (Oud), Amber, Rosemary / Base - Leather, Vetiver, Musk", "category": ["Woody", "Oud", "Spicy", "Aromatic", "Chypre", "Citrus"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Khamrah Dukhan", "brand": "Lattafa", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Spices, Pimento, Mandarin / Heart - Incense, Labdanum, Orange Blossom, Patchouli / Base - Tobacco, Praline, Amber, Tonka Bean, Benzoin", "category": ["Oriental", "Spicy", "Sweet", "Citrus", "Smoky", "Chypre"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Khamrah Original", "brand": "Lattafa", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Cinnamon, Nutmeg, Bergamot / Heart - Dates, Praline, Tuberose, Mahonial / Base - Vanilla, Tonka Bean, Amberwood, Myrrh, Benzoin, Akigalawood", "category": ["Oriental", "Spicy", "Sweet", "Gourmand", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Khamrah Qahwa", "brand": "Lattafa", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Cinnamon, Cardamom, Ginger / Heart - Praline, Candied Fruits, White Flowers / Base - Coffee, Vanilla, Tonka Bean, Benzoin, Musk", "category": ["Gourmand", "Spicy", "Sweet", "Oriental", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Khamrah Waha", "brand": "Lattafa", "gender": "Unisex", "season": "Fall-Winter", "notes": "Spicy-sweet (date, cinnamon, vanilla family)", "category": ["Oriental", "Spicy", "Sweet", "Gourmand", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Kiaana Angel", "brand": "Afnan", "gender": "Female", "season": "Spring, summer", "notes": "Top Notes: Pistachio Gelato (or Ice Cream), Italian BergamotMiddle (Heart) Notes: Jasmine, Raspberry, White Peach, PearBase Notes: Cedarwood, Sandalwood, Tonka Bean", "category": ["Gourmand", "Floral", "Fruity", "Woody", "Creamy", "Chypre"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Le Parfum", "brand": "Blue for Men", "gender": "Male/Unisex", "season": "Fall, Winter", "notes": "Top - Cardamom / Heart - Lavender, Iris / Base - Vanilla, Oriental Woods", "category": ["Woody", "Oriental", "Spicy", "Aromatic", "Fougere", "Gourmand"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Lemon Sorbet", "brand": "Arabiyat Sugar", "gender": "Unisex", "season": "Spring, summer", "notes": "Top Notes: Zesty lemon and a subtle nuance of rumMiddle/Heart Notes: Sweet gourmand and sorbet cream accordBase Notes: Creamy vanilla and soft musk", "category": ["Gourmand", "Fruity", "Oriental", "Creamy", "Sweet", "Vanilla", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Love & Peace", "brand": "Lattafa", "gender": "Unisex/Female", "season": "Spring-Fall", "notes": "Top Notes: Almond, Black Currant, and BergamotMiddle (Heart) Notes: Rose and TuberoseBase Notes: Sandalwood, Vanilla, and Heliotrope", "category": ["Floral", "Sweet", "Gourmand", "Woody", "Chypre", "Citrus"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Luxe Chic", "brand": "Maison Alhambra", "gender": "Female/Unisex", "season": "Spring, Fall", "notes": "Top - Tangerine, Freesia / Heart - Lily of the Valley, Jasmine, Rose / Base - Musk, Sandalwood, Amber", "category": ["Floral", "Fresh", "Woody", "Creamy", "Amber", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Maitha Oil (Attar)", "brand": "Lattafa", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Anise / Heart - Caramel / Base - Vanilla, Tonka Bean, Musk", "category": ["Gourmand", "Sweet", "Vanilla", "Animalic", "Aromatic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Majestic Supreme", "brand": "Le Falcone", "gender": "Women/Unisex", "season": "Fall-Winter / versatile", "notes": "Top - Rose, peony, pink pepper / Heart - Raspberry blossom, jasmine / Base - Amber, papyrus, tonka, vanilla", "category": ["Floral", "Sweet", "Fruity", "Gourmand", "Spicy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Malika", "brand": "Nusuk", "gender": "Female", "season": "Fall , winter ", "notes": "Top Notes: Ozonic notes, apple, aldehydic notes, tarragon, bergamot, and orangeHeart Notes: Lily of the valley, jasmine, rose, carnation, orchid, and honeysuckleBase Notes: Musk, amber, vanilla, sandalwood, cedarwood, and orris", "category": ["Floral", "Oriental", "Citrus", "Woody", "Gourmand", "Sweet"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Mango Affogato", "brand": "Arabiyat Sugar", "gender": "Unisex", "season": "Spring-Summer / year-round", "notes": "Top - Mango, nutmeg, clove / Heart - Leather, saffron, amber, moss / Base - Akigalawood, patchouli, vetiver, cypriol", "category": ["Fruity", "Woody", "Spicy", "Oriental", "Leather", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Mango Ice", "brand": "Gulf Orchid", "gender": "Unisex", "season": "Spring-Summer", "notes": "Top Notes: Mango, Lemon, Ginger, RhubarbHeart (Middle) Notes: White Flowers, Amber, LicoriceBase Notes: Musk, Vanilla, Caramel, Chestnut", "category": ["Fruity", "Fresh", "Gourmand", "Sweet", "Spicy", "Vanilla", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Marshmallow Blush", "brand": "Paris Corner", "gender": "Female/Unisex", "season": "Fall, Winter", "notes": "Top - Marshmallow, Sweet / Heart - Fruity / Base - Vanilla, Musk", "category": ["Gourmand", "Sweet", "Fruity", "Vanilla", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Marshmallow Dreams", "brand": "NatureWell", "gender": "Female", "season": "Fall, winter", "notes": "Top Notes: Lemon Sugar & MarshmallowMid Notes: Coconut CreamBase Notes: Vanilla Mousse & Whipped Cream", "category": ["Gourmand", "Sweet", "Fruity", "Vanilla", "Citrus"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Marshmallows Kiss", "brand": "Mamlakat Al Oud", "gender": "Unisex", "season": "Fall, Winter, Spring", "notes": "Top - Strawberry, Blackberry (or Caramel/Milk) / Heart - Jasmine, Rose, Marshmallow, Vanilla, Honey / Base - Vanilla, Musk, Praline, Tonka", "category": ["Gourmand", "Floral", "Sweet", "Fruity", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Mayar", "brand": "Lattafa", "gender": "Female", "season": "Spring, Summer", "notes": "Top - Lychee, Raspberry, Violet Leaf / Heart - Peony, White Rose, Jasmine / Base - Musk, Vanilla", "category": ["Floral", "Fruity", "Fresh", "Gourmand", "Powdery", "Sweet"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Mayar Cherry Intense", "brand": "Lattafa", "gender": "Female", "season": "Fall, Winter", "notes": "Top - Strawberry, Bergamot / Heart - Cherry Jam, Cacao / Base - Vanilla, Amber, Patchouli", "category": ["Fruity", "Gourmand", "Sweet", "Chypre", "Citrus"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Milano", "brand": "Valentine", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Raspberry, Peach, Bergamot / Heart - Rose, Jasmine, Orange Blossom / Base - Vanilla, Amber, Woods", "category": ["Floral", "Fruity", "Sweet", "Citrus", "Chypre", "Gourmand"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Momento", "brand": "Riiffs", "gender": "Unisex", "season": "Winter", "notes": "Top Notes: Sugar, Saffron, and Mandarin give a sweet and citrus opening.Heart (Middle) Notes: Tonka Bean, Damask Rose, and Agarwood (Oud) create a floral and rich center.Base Notes: Caramel, Amberwood, and Cedar leave a warm and woody finish.", "category": ["Aromatic", "Citrus", "Oriental", "Oud", "Sweet", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Mystique", "brand": "Armaf", "gender": "Female", "season": "Fall, Winter", "notes": "Top - Pear, Tangerine, Bergamot, Orange / Heart - Vanilla, Strawberry, Mimosa, Rose, Ylang Ylang, Jasmine, Passionfruit / Base - Vanilla, Coffee, Tonka Bean, Patchouli, Vetiver", "category": ["Floral", "Fruity", "Gourmand", "Citrus", "Woody"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Mystique Charm", "brand": "Dorall Collection", "gender": "Female", "season": "Spring, summer", "notes": "Top Notes: Clementine, Cappuccino, Cactus, Pepper, and BlackberryMiddle (Heart) Notes: Mimosa, Hortensia (Hydrangea), Camellia, and OrchidBase Notes: Woody Notes, Blackberry, Musk, Amber, and Red Berries", "category": ["Sweet", "Floral", "Oriental", "Fruity", "Spicy", "Amber", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Nagham", "brand": "Atyaab", "gender": "Unisex", "season": "Winter", "notes": "Top Notes: Rose, Jasmine, and BergamotMiddle (Heart) Notes: Amber, Vetiver, and Candied Fruit (such as sweet strawberries and cherries)Base Notes: Vanilla, Cedarwood, and Sandalwood", "category": ["Floral", "Woody", "Oriental", "Sweet", "Chypre", "Citrus"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Nasmaat", "brand": "Lattafa", "gender": "Unisex", "season": "Spring, Fall", "notes": "Top - Blackcurrant, Apricot, Pineapple / Heart - Magnolia, Cyclamen, Jasmine, Orange Blossom, Rose / Base - Vanilla, Cashmeran, Caramel, Sandalwood", "category": ["Floral", "Fruity", "Sweet", "Gourmand", "Woody"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Natural Intense Body Spray", "brand": "Mayar", "gender": "Female", "season": "Fall, Winter", "notes": "Top - Sweet Gourmand / Heart - Vanilla / Base - Musk", "category": ["Gourmand", "Sweet", "Vanilla", "Animalic", "Musky"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Nebras", "brand": "Lattafa", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Red Berries, Mandarin Orange / Heart - Vanilla, Cacao, Rose / Base - Sugar, Tonka Bean, Amber, Musk", "category": ["Gourmand", "Fruity", "Sweet", "Citrus", "Vanilla", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Nebras Elixir", "brand": "Lattafa", "gender": "Unisex", "season": "Fall, Winter, Mild Spring", "notes": "Top - Milk Candy, Whipped Cream / Heart - Sugar Cane, Heliotrope / Base - Vanilla, Ambroxan, Musk", "category": ["Gourmand", "Sweet", "Amber", "Creamy", "Floral"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Nero Xtravagant", "brand": "Valentine (Urban Collection)", "gender": "Male/Unisex (leans masculine)", "season": "Fall, Winter (versatile)", "notes": "Top - Calabrian Bergamot, Espresso Coffee Accord / Heart - Coffee / Base - Vetiver", "category": ["Woody", "Fresh", "Aromatic", "Chypre", "Citrus", "Gourmand"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Noor", "brand": "Riiffs", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top Notes: Caramel and milkMiddle (Heart) Notes: Gourmand accord and lily of the valleyBase Notes: Vanilla, musk, and praline", "category": ["Gourmand", "Floral", "Sweet", "Vanilla", "Animalic", "Creamy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Nuha Vanilla Pearl", "brand": "Khadlaj", "gender": "Female", "season": "Fall, Winter", "notes": "Top - Blackcurrant, Strawberry, Freesia / Heart - Raspberry, Magnolia, Cashmere Wood / Base - Vanilla, Caramel, Moss", "category": ["Fruity", "Gourmand", "Floral", "Sweet", "Woody"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Nyla", "brand": "Arabiyat Prestige", "gender": "Female", "season": "Spring, Summer", "notes": "Top Notes: Coconut, Peach, Bergamot, and Mandarin (offering a fresh, sun-kissed fruit opening)Heart Notes: Tiare Flower, White Flowers, Jasmine, and Rose (providing an exotic and romantic floral bouquet)Base Notes: White Musk, Patchouli, Sandalwood, and Heliotrope (delivering a creamy, soft, and sensual woody finish)", "category": ["Floral", "Fruity", "Fresh", "Citrus", "Woody", "Creamy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Nyla Vanielle", "brand": "Arabiyat Prestige", "gender": "Female", "season": "Fall, Winter", "notes": "Top - Jasmine, Vanilla Bean / Heart - Caramel, Amber / Base - Musk, Tonka Bean, Vanilla", "category": ["Gourmand", "Sweet", "Floral", "Vanilla", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Obsidian", "brand": "French Avenue", "gender": "Unisex/Male", "season": "Fall-Winter", "notes": "Top Notes: Aldehydes, Grapefruit, BergamotHeart Notes: Myrrh, Jasmine, LabdanumBase Notes: Vanilla, Amber, Tonka Bean", "category": ["Woody", "Oriental", "Smoky", "Chypre", "Citrus", "Floral", "Gourmand"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Odyssey Candee", "brand": "Armaf", "gender": "Female-leaning", "season": "Fall, Winter", "notes": "Top - Strawberry, Raspberry, Peach, Bergamot / Heart - Caramel, Jasmine / Base - Patchouli, Musk, Amber", "category": ["Fruity", "Gourmand", "Sweet", "Chypre", "Citrus", "Floral"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Odyssey Marshmallow", "brand": "Armaf", "gender": "Unisex", "season": "Spring, Fall, Winter", "notes": "Top - Apple, Lemon, Coconut, Peony, Lily of the Valley / Heart - Strawberry, Peach, Raspberry, Apricot, Marshmallow, Orange Blossom / Base - Vanilla, Praline, Tonka, Amber, Musk, Mascarpone", "category": ["Gourmand", "Fruity", "Sweet", "Floral", "Citrus"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Opulent Dubai", "brand": "Lattafa", "gender": "Unisex", "season": "Spring, Summer (versatile year-round in mild climates)", "notes": "Top - Mango, Grapefruit, Lemon, Ginger / Heart - Jasmine, Cedarwood, Violet / Base - Woodsy notes, Ambergris, Benzoin, Oakmoss", "category": ["Fruity", "Woody", "Fresh", "Floral", "Amber", "Citrus", "Oriental"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Oud Mood", "brand": "Lattafa", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Rose, Saffron, Pimento / Heart - Agarwood (Oud), Caramel, Floral Notes, Patchouli / Base - Woody Notes, Amber, Resins, Incense, Musk", "category": ["Oriental", "Oud", "Woody", "Gourmand", "Smoky"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Panache Angel Dust", "brand": "Khadlaj", "gender": "Female", "season": "Spring, winter , fall", "notes": "Top Notes: Vanilla, Mandarin, and Red CurrantMiddle (Heart) Notes: Tuberose, Sandalwood, and RumBase Notes: Vanilla, Whipped Cream, Musk, and Benzoin", "category": ["Floral", "Sweet", "Powdery", "Gourmand", "Woody", "Citrus", "Creamy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Peach Velvet", "brand": "Khadlaj", "gender": "Female", "season": "Spring, Summer, Fall", "notes": "Top - Guava, Peach, Nectarine / Heart - Vanilla, Ginger, Cinnamon, Amber / Base - Caramel, Musk, Sandalwood", "category": ["Fruity", "Gourmand", "Sweet", "Spicy", "Woody", "Creamy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Pecan Butter Cookie", "brand": "Arabiyat Sugar", "gender": "Unisex/Female", "season": "Fall-Winter", "notes": "Top - Pecan, coconut milk, butter / Heart - Hazelnut, almond, roasted nuts / Base - Hazelnut, vanilla, ambergris", "category": ["Gourmand", "Sweet", "Amber", "Creamy", "Fruity"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Petra", "brand": "Lattafa", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top Notes: Plum, RumHeart (Middle) Notes: Tuberose, CoconutBase Notes: Praline, Musk, Vanilla", "category": ["Gourmand", "Fruity", "Floral", "Sweet", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Pink Velvet", "brand": "Maison Alhambra", "gender": "Female", "season": "Spring-Fall", "notes": "Top Notes: Bulgarian Rose and May RoseMiddle/Heart Notes: Turkish Rose and SaffronBase Notes: Patchouli, Tonka Bean, and Vanilla", "category": ["Floral", "Sweet", "Powdery", "Gourmand", "Oriental", "Vanilla", "Woody"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Pina Colada Musk Collection Body Spray", "brand": "Gulf Orchid", "gender": "Unisex", "season": "Spring, Summer", "notes": "Top - Pineapple, Coconut / Heart - Tropical / Base - Musk", "category": ["Fruity", "Fresh", "Sweet", "Animalic", "Musky", "Woody"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Prive Rose", "brand": "Ameerat Al Arab", "gender": "Female", "season": "Spring , summer", "notes": "Top Notes: Strawberry, Grapes, and OrangeMiddle (Heart) Notes: Rose, White Musk, Jasmine, Gardenia, Ylang-Ylang, and LilyBase Notes: Tonka Bean, Amber, and Sandalwood", "category": ["Floral", "Sweet", "Gourmand", "Fruity", "Woody", "Citrus", "Creamy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Qaed Al Fursan (Original)", "brand": "Lattafa", "gender": "Unisex (leans masculine)", "season": "Fall, Winter", "notes": "Top - Pineapple, Saffron / Heart - Balsam Fir, Jasmine / Base - Cedar, Amber, Agarwood (Oud)", "category": ["Fruity", "Woody", "Oud", "Oriental", "Floral"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Qaed Al Fursan Unlimited", "brand": "Lattafa", "gender": "Male/Unisex", "season": "Spring, Fall", "notes": "Top - Coconut, Pineapple, Citruses / Heart - Ylang-Ylang, Frangipani, Jasmine / Base - Vanilla, Musk, Sandalwood, Sweet Notes", "category": ["Fruity", "Floral", "Sweet", "Woody", "Citrus"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Qaed Al Fursan Untamed", "brand": "Lattafa", "gender": "Male/Unisex", "season": "Spring, Fall", "notes": "Top - Apple, Citrus / Heart - Floral / Base - Sweet, Woody", "category": ["Fruity", "Woody", "Fresh", "Citrus", "Sweet"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Raheeq", "brand": "Nusuk", "gender": "Unisex", "season": "Fall , winter", "notes": "Top Notes: Honey, Blood Orange, Apricot, and LemonMiddle (Heart) Notes: Caramel, Coconut, and MagnoliaBase Notes: Vanilla Absolute, Musk, and Sandalwood", "category": ["Floral", "Sweet", "Gourmand", "Citrus", "Woody", "Creamy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Raneen", "brand": "Lattafa", "gender": "Female", "season": "Fall, Winter", "notes": "Top - Fruity, Sweet / Heart - Floral / Base - Vanilla, Musk", "category": ["Floral", "Fruity", "Sweet", "Gourmand", "Vanilla", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Rave Now (for Women)", "brand": "Lattafa", "gender": "Female", "season": "Spring, Fall", "notes": "Top - Red Fruits, Orange / Heart - Marshmallow, Jasmine, Lily of the Valley / Base - Vanilla, Musk, Moss", "category": ["Fruity", "Gourmand", "Floral", "Citrus", "Sweet", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Rave Now Intense", "brand": "Lattafa", "gender": "Male/Unisex", "season": "Spring, Fall", "notes": "Top - Cucumber, Watermelon, Tangerine / Heart - Basil, Sage / Base - Sandalwood, Leather, Cedar", "category": ["Fresh", "Woody", "Aromatic", "Creamy", "Leather"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Rave Rage", "brand": "Lattafa", "gender": "Unisex (leans masculine)", "season": "Year-round", "notes": "Top - Apple, mint / Heart - Geranium, cinnamon, lavender / Base - Vanilla, Peru balsam, cedarwood, guaiac wood", "category": ["Fresh", "Woody", "Spicy", "Aromatic", "Fougere", "Gourmand", "Oriental"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Red 500", "brand": "Baraja", "gender": "Unisex/Male", "season": "Fall, Winter", "notes": "Top - Red Fruits, Spices / Heart - Sweet Notes / Base - Woody, Musk", "category": ["Fruity", "Woody", "Spicy", "Animalic", "Musky", "Sweet"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Red Velvet Delicacy", "brand": "Armaf", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Strawberry, Lemon / Heart - Whipped Sugar, Sugarberry, Frangipani / Base - Vanilla Bean, Musk, Amber", "category": ["Gourmand", "Fruity", "Sweet", "Vanilla", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Royal Men", "brand": "Al Rehab", "gender": "Male", "season": "Fall, Winter", "notes": "Top - Spicy, Citrus, Woody / Heart - Floral, Sweet / Base - Amber, Musk, Vanilla", "category": ["Woody", "Spicy", "Oriental", "Sweet", "Citrus", "Gourmand", "Vanilla", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Safa", "brand": "Nusuk", "gender": "Unisex/Female", "season": "Spring-Summer / versatile", "notes": "Top - Marshmallow, Strawberry, Lemon / Heart - Coconut, Sugar, Nectarine / Base - Vanilla, Musk, Ambroxan", "category": ["Gourmand", "Fruity", "Sweet", "Amber", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Sakeena", "brand": "Lattafa", "gender": "Female/Unisex", "season": "Fall, Winter", "notes": "Top - Passionfruit, Mandarin Orange, Ozonic Notes / Heart - Raspberry, Rose, Orange Blossom, Sea Salt / Base - Toffee, Praline, Vanilla, Musk", "category": ["Fruity", "Gourmand", "Floral", "Sweet", "Citrus", "Aquatic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Samiya", "brand": "Khadlaj", "gender": "Female", "season": "Spring , fall", "notes": "Top/Head Notes: Jasmine, Lily of the ValleyMiddle/Heart Notes: Amber, VioletBase Notes: Oud, Saffron, Sandalwood", "category": ["Floral", "Oriental", "Woody", "Powdery", "Creamy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Sceptre Malachite", "brand": "Maison Alhambra", "gender": "Unisex", "season": "Spring-Summer", "notes": "Top - Green tangerine, bergamot, blackcurrant / Heart - Aromatic + spicy notes, lavender, pink pepper, jasmine / Base - Amber, musk, woody notes, vetiver", "category": ["Fresh", "Aromatic", "Woody", "Chypre", "Citrus", "Floral"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Sensual Vanilla", "brand": "Maison Alhambra", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top Note: Bitter AlmondMiddle Notes: Vanilla, Floral NotesBase Notes: Vanilla Absolute, Tonka Bean, Sandalwood", "category": ["Oriental", "Gourmand", "Woody", "Creamy", "Sweet", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Silver", "brand": "Al Rehab", "gender": "Unisex/Male", "season": "Spring, Summer", "notes": "Top - Fresh Citrus, Metallic / Heart - Floral / Base - Musk, Sweet", "category": ["Fresh", "Citrus", "Metallic", "Animalic", "Musky"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Soft", "brand": "Al Rehab", "gender": "Unisex (leans feminine)", "season": "Fall, Winter", "notes": "Top - Citruses / Heart - Orchid, Jasmine, Vanilla, Caramel / Base - White Musk, Woody Notes, Vetiver", "category": ["Floral", "Sweet", "Gourmand", "Woody", "Citrus"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Spectre Original", "brand": "French Avenue", "gender": "Male/Unisex (leans masculine)", "season": "Fall, Winter", "notes": "Top - Incense, Guaiac Wood, Saffron / Heart - Leather, Amberwood, Violet, Sugar Cane / Base - Smoke, Patchouli, Sandalwood, Woodsy Notes, Black Musk", "category": ["Woody", "Leather", "Oriental", "Amber", "Smoky", "Creamy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Strawberries & Cream", "brand": "Royal Apothic", "gender": "Female", "season": "Spring, summer", "notes": "Top Notes: Raspberry and plum (or juicy brightness like strawberry, raspberry, apple, and nectarine)Heart / Middle Notes: Strawberry and whipped creamBase Notes: Sugar cubes, caramel, tonka vanilla, and soft amber", "category": ["Gourmand", "Fruity", "Sweet", "Vanilla", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Strawberry Tres Leches", "brand": "Arabiyat Sugar", "gender": "Female", "season": "Spring-Summer / year-round", "notes": "Top Notes: Strawberry, Milk, Nectarine, FreesiaHeart / Middle Notes: Marshmallow, Milk Candy, Caramel, Orange BlossomBase Notes: Vanilla, White Musk, Ambergris", "category": ["Gourmand", "Fruity", "Sweet", "Floral", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Sugar Crown", "brand": "Lattafa", "gender": "Female/Unisex", "season": "Fall-Winter", "notes": "Top Notes: Bitter orange, lemon, and candied fruitsMiddle Notes (Heart): Bubble gum, blueberry, peach, peach blossom, Bulgarian rose, ginger, and cinnamonBase Notes: Ambroxan, musk, and cedar", "category": ["Gourmand", "Sweet", "Spicy", "Citrus", "Amber", "Fruity"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Sugar Me Dulce De Leche", "brand": "Maison Alhambra", "gender": "Unisex/Female", "season": "Fall-Winter", "notes": "Dulce de leche / caramel-vanilla gourmand", "category": ["Gourmand", "Sweet", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Sugarcane Vanilla", "brand": "Arabiyat Prestige", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top Notes: Raspberry, Cherry, MandarinMiddle/Heart Notes: Lactones (milky/creamy notes), Vanilla, White FlowersBase Notes: Sandalwood, Musk", "category": ["Sweet", "Gourmand", "Fruity", "Floral", "Creamy", "Woody", "Citrus"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Supremacy Only Intense", "brand": "Afnan", "gender": "Male", "season": "Spring, autumn", "notes": "Top Notes: Black Currant, Bergamot, and AppleMiddle (Heart) Notes: Oakmoss, Patchouli, and LavenderBase Notes: Ambergris, Musk, and Saffron", "category": ["Woody", "Fruity", "Fresh", "Chypre", "Fougere", "Amber", "Oriental"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Sweet Surrender", "brand": "Mahajan", "gender": "Female", "season": "Fall-Winter / versatile", "notes": "Top Note: CaramelMiddle Notes: Coumarin (sweet, vanilla-like scent) and HoneyBase Notes: White Musk and Vanilla", "category": ["Gourmand", "Sweet", "Fougere", "Vanilla", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Sweet Surrender Pink Parfait", "brand": "Mahajan", "gender": "Female", "season": "Spring-Summer / year-round", "notes": "Top Notes: Graham Crackers, Marshmallow, Strawberry, Blackcurrant, and Chocolate (Strawberry S'mores)Middle (Heart) Notes: Marshmallow, Orange Blossom, and JasmineBase Notes: Vanilla, Whipped Cream, Sandalwood, Amber, and Musk", "category": ["Gourmand", "Fruity", "Sweet", "Floral", "Creamy", "Woody"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Tahira", "brand": "Riiffs", "gender": "Female", "season": "Spring , summer, fall", "notes": "Top Notes: Almond and Dragon fruitMiddle (Heart) Notes: Rose de Mai, Gardenia, and Praline (often listed as Rose de Mai and Gardenia with praline accents in the blend)Base Notes: Vanilla Absolute, Tonka Bean, and Patchouli", "category": ["Floral", "Oriental", "Gourmand", "Sweet", "Woody", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Taif", "brand": "Riiffs", "gender": "Unisex", "season": "Versatile (Spring-Summer preferred)", "notes": "Top - Ginger, Calabrian Bergamot, Lemon, Orange Blossom / Heart - Musk, Rose Petals, Tuberose / Base - Vanilla Bean, Amberwood, Clearwood", "category": ["Floral", "Fresh", "Woody", "Citrus", "Amber", "Chypre"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Teriaq", "brand": "Lattafa", "gender": "Unisex (leans feminine)", "season": "Fall, Winter", "notes": "Top - Caramel, Bitter Almond, Apricot, Pink Pepper / Heart - Honey, Rhubarb, White Flowers, Rose / Base - Leather, Vanilla, Musk, Vetiver, Labdanum", "category": ["Gourmand", "Floral", "Oriental", "Sweet", "Chypre", "Leather"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Teriaq Intense", "brand": "Lattafa", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Saffron, Bergamot / Heart - Plum Liquor, Cinnamon / Base - Amber, Tonka Bean, Benzoin", "category": ["Oriental", "Spicy", "Sweet", "Boozy", "Chypre", "Citrus"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "The King", "brand": "Ali", "gender": "Male", "season": "Fall-Winter / versatile", "notes": "Top Notes: Plum, Ozonic notes, Grapefruit, BergamotMiddle (Heart) Notes: Hazelnut, Honey, Cedar, Cashmere Wood, Orange Blossom, JasmineBase Notes: Amberwood, Patchouli, Oakmoss, Vetiver", "category": ["Woody", "Oriental", "Citrus", "Chypre", "Floral", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Tiramisu Candy", "brand": "Rizz", "gender": "Female", "season": "Fall , winter", "notes": "Top Note: BergamotMiddle Notes: Black Currant, Strawberry, and MilkBase Notes: Musk and Vanilla", "category": ["Gourmand", "Fruity", "Sweet", "Citrus"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Tiramisu Coco", "brand": "Zimaya", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top Notes: Amaretto and CoffeeMiddle Notes: Ice cream, Biscuit, and VanillaBase Notes: Vanilla, Brown sugar, and Amber", "category": ["Gourmand", "Oriental", "Sweet", "Vanilla", "Amber", "Creamy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Toffee Ganache", "brand": "Arabiyat Sugar", "gender": "Unisex", "season": "Fall-Winter", "notes": "Top Notes: Hazelnut, Clove, Milk (or Vanilla Cream), and VanillaMiddle (Heart) Notes: Cinnamon, Toffee, and White FlowersBase Notes: Gourmand Accord, Milk, Biscuit (Speculoos/Biscoff), and Spices", "category": ["Gourmand", "Sweet", "Spicy", "Creamy", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Tubbees Tres Leches", "brand": "Grandeur", "gender": "Unisex", "season": "Fall, winter", "notes": "Top Notes: Vanilla bean, cold milk accord, sweet notes, spicy notes, and caramelMiddle Notes (Heart): Milk, chocolate, and floral notes", "category": ["Gourmand", "Sweet", "Vanilla", "Creamy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Vanilla", "brand": "Bellavita", "gender": "Female", "season": "Fall, Winter", "notes": "Top - Aldehydes, Heliotrope, Coconut, Vanilla / Heart - Vanilla, Mango / Base - White Musk, Coconut, Vanilla Absolute", "category": ["Gourmand", "Sweet", "Fruity", "Floral", "Powdery"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Vanilla Addiction", "brand": "Gulf Orchid", "gender": "Unisex/Female", "season": "Fall-Winter", "notes": "Top Notes: Coconut, Lavender, and Lily of the ValleyHeart (Middle) Notes: Tonka Bean, Jasmine, Rose, and PatchouliBase Notes: Vanilla, Amber, and Musk", "category": ["Gourmand", "Sweet", "Floral", "Aromatic", "Fougere", "Fruity"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Vanilla Aura", "brand": "Maison Asrar", "gender": "Female/Unisex", "season": "Fall, Winter", "notes": "Top - Vanilla / Heart - Creamy Sweet / Base - Vanilla, Musk", "category": ["Gourmand", "Sweet", "Creamy", "Vanilla", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Vanilla Ayelet", "brand": "Khayali", "gender": "Unisex", "season": "Fall-Winter", "notes": "Vanilla orchid, jasmine / Brown sugar, tonka / Amber, musk, patchouli (Kayali-inspired)", "category": ["Gourmand", "Floral", "Sweet", "Vanilla", "Woody"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Vanilla Cream Macaron", "brand": "Arabiyat Sugar", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top Note: Ripe BananaMiddle Note: Chantilly CreamBase Note: Custard Sauce (or Vanilla/Vanilla Musk)", "category": ["Gourmand", "Fruity", "Sweet", "Vanilla", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Vanilla Dunes", "brand": "Khadlaj", "gender": "Unisex", "season": "Autumn, Winter", "notes": "Top - Vanilla, Cinnamon, Cardamom, Bergamot / Heart - Orange Blossom, Guaiac Wood, Bourbon / Base - Praline, Amber, Musk", "category": ["Gourmand", "Spicy", "Woody", "Citrus", "Sweet"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Vanilla Freak (Give Me Gourmand)", "brand": "Lattafa", "gender": "Unisex / Female-leaning", "season": "Fall, Spring", "notes": "Top - Cupcake / Heart - Sugar Frosting, Almond, Cinnamon / Base - Butter, Vanilla, Musk", "category": ["Gourmand", "Sweet", "Creamy", "Spicy", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Vanilla Madness", "brand": "Mamlakat Al Oud", "gender": "Unisex (leans feminine)", "season": "Fall, Winter (versatile year-round)", "notes": "Top - Vanilla (woody tones), Lavender, Cacao, Ginger / Heart - Vanilla Caviar / Base - Vanilla Absolute", "category": ["Gourmand", "Sweet", "Aromatic", "Fougere", "Spicy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Vanilla Milkshake", "brand": "Snack House", "gender": "Unisex", "season": "Fall, winter", "notes": "Top Notes: Vanilla Orchid and JasmineMiddle (Heart) Notes: Brown Sugar and Tonka BeanBase Notes: Amber, Amberwood, Musk, and Patchouli", "category": ["Gourmand", "Oriental", "Floral", "Amber", "Sweet", "Woody"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Vanilla Musk", "brand": "NatureWell", "gender": "Unisex", "season": "Fall, winter", "notes": "Top Notes: Sugared Petals & Mandarin MuskMid Notes: Vanilla Cream & SpiceBase Notes: Sleek Woods & Tonka", "category": ["Gourmand", "Sweet", "Citrus", "Vanilla", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Vanilla Seduction", "brand": "Maison Asrar", "gender": "Female/Unisex", "season": "Fall, Winter", "notes": "Top - Plum, Jasmine, Lily of the Valley / Heart - Vanilla, Brown Sugar, Caramel / Base - Tonka, Patchouli, Amber, Musk", "category": ["Gourmand", "Floral", "Sweet", "Vanilla", "Woody"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Vanilla Skin", "brand": "Phlur", "gender": "Unisex (female-leaning)", "season": "Fall, Winter", "notes": "Top - Sugar, Pink Pepper, Apple / Heart - Cashmere Wood, Jasmine, Lily / Base - Vanilla, Sandalwood, Agarwood, Benzoin", "category": ["Gourmand", "Woody", "Sweet", "Floral", "Oud"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Velvet Breeze", "brand": "Mamlakat Al Oud", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Italian Bergamot, Pistachio Gelato, Hazelnut, Sweet Rum, Cardamom / Heart - Geranium, White Peony, Muguet, Jasmine / Base - Amber, Musk, Woody Notes", "category": ["Gourmand", "Floral", "Woody", "Chypre", "Citrus", "Spicy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Vulcan Baie", "brand": "French Avenue", "gender": "Unisex", "season": "Spring, Summer", "notes": "Top - Blackberry, Black Currant, Rosemary, Bergamot / Heart - Raspberry, Vodka, Basil, Lily of the Valley / Base - Strawberry, Musk, Peach, Amber, Sandalwood, Patchouli, Incense", "category": ["Fruity", "Fresh", "Aromatic", "Woody", "Oriental", "Chypre"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Whipped Pleasure (Give Me Gourmand)", "brand": "Lattafa", "gender": "Female", "season": "Fall, Winter", "notes": "Top - Caramel, Popcorn, Salted Caramel / Heart - Milk, Jasmine / Base - Tonka, Benzoin, Musk, Ambrofix", "category": ["Gourmand", "Sweet", "Floral", "Oriental", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Yara Candy Body Spray", "brand": "Lattafa", "gender": "Female", "season": "Fall, Winter", "notes": "Top - Candy, Sweet / Heart - Fruity / Base - Vanilla, Musk", "category": ["Gourmand", "Sweet", "Fruity", "Vanilla", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Yara Elixir", "brand": "Lattafa", "gender": "Female", "season": "Fall, Winter, Cool Spring Days", "notes": "Top - Strawberry S'mores, Black Currant / Heart - Jasmine, Orange Blossom / Base - Vanilla, Caramel, Amber, Musk", "category": ["Gourmand", "Floral", "Sweet", "Fruity", "Citrus"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Yara Original", "brand": "Lattafa", "gender": "Female", "season": "Spring-Summer", "notes": "Top - Orchid, heliotrope, tangerine / Heart - Gourmand accord, tropical fruits / Base - Vanilla, musk, sandalwood", "category": ["Floral", "Gourmand", "Fruity", "Woody", "Creamy", "Powdery"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Yara Tous", "brand": "Lattafa", "gender": "Female", "season": "Summer", "notes": "Top Notes: Mango, coconut, passion fruitMiddle Notes: Jasmine, orange blossom, heliotropeBase Notes: Vanilla, cashmeran, musk", "category": ["Floral", "Fruity", "Sweet", "Gourmand", "Citrus", "Powdery"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Zainab Oil", "brand": "Khadlaj", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Bergamot, Gardenia, Almond / Heart - Coconut, Caramel / Base - Patchouli, Vanilla, Musk", "category": ["Gourmand", "Floral", "Sweet", "Chypre", "Citrus"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Zenith", "brand": "Riiffs", "gender": "Unisex", "season": "Spring, summer, winter", "notes": "Top Notes: Coconut, Vanilla, Creamy AccordsHeart (Middle) Notes: Fruity Notes, Jasmine, Powdery AccordsBase Notes: Vanilla, Musk, Woody Notes", "category": ["Gourmand", "Sweet", "Powdery", "Fruity", "Creamy", "Floral"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Zukhruf Pink", "brand": "Zimaya", "gender": "Unisex", "season": "Winter", "notes": "Top Notes: Orchid, Heliotrope, and VanillaHeart (Middle) Notes: Musk, Marshmallow, and Almond MilkBase Notes: Amber, Vanilla, and Sandalwood", "category": ["Gourmand", "Floral", "Creamy", "Woody", "Powdery"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Victoria", "brand": "Lattafa", "gender": "Unisex", "season": "Spring, summer ", "notes": "Top Notes: Lemon Meringue Pie (offering a bright, zesty, and sweet citrus opening)Middle (Heart) Notes: Neroli (lending a delicate, sophisticated, and clean floral touch)Base Notes: Vanilla (providing a smooth, creamy, and comforting warm finish)", "category": ["Gourmand", "Floral", "Fruity", "Citrus", "Creamy", "Sweet", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": "EDP"}, {"name": "Qimmah", "brand": "Lattafa", "gender": "Female", "season": "Fall, Winter", "notes": "Top Notes: Almond, CoffeeHeart (Middle) Notes: Jasmine, Tuberose, Tonka BeanBase Notes: Vanilla, Cacao, Sandalwood", "category": ["Gourmand", "Floral", "Woody", "Creamy", "Sweet"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": "EDP"}, {"name": "Tiramisu S'mores", "brand": "Zimaya", "gender": "Female", "season": "Fall, Winter", "notes": "Top Notes: Marshmallow, Chocolate, Coffee, Bergamot, and Nectarine Blossom.Middle (Heart) Notes: Biscuit, Vanilla, Milk, Almond, and Musk.Base Notes: Sugar, Caramel, Creamy Notes, Amber, and Musk.", "category": ["Gourmand", "Sweet", "Creamy", "Chypre", "Citrus"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Tiramisu caramel", "brand": "Zimaya", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top Note: CaramelMiddle (Heart) Notes: Honey, Coumarin, and Woody NotesBase Notes: Vanilla, Whiskey, and Musk", "category": ["Gourmand", "Sweet", "Boozy", "Fougere", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Orhan", "brand": "Nusuk", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top Notes: Blackberry, BlueberryMiddle Notes: Freesia, Lavender, RoseBase Notes: Vanilla, Raspberry, Oakmoss, Patchouli", "category": ["Gourmand", "Fougere", "Floral", "Fruity", "Woody", "Aromatic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": "EDP"}, {"name": "Nisma", "brand": "Arabiyat prestige", "gender": "Female", "season": "Summer, spring", "notes": "Top Notes: Pistachio, Hazelnut, and Cassis (Blackcurrant bud)Middle (Heart) Notes: Raspberry, Lily of the Valley, Jasmine, and PeonyBase Notes: Sandalwood, Vanilla, Tonka Bean, Maltol, and Lactonic notes", "category": ["Gourmand", "Fruity", "Creamy", "Floral", "Woody"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": "EDP"}, {"name": "Lady glamour", "brand": "Arabiyat prestige", "gender": "Female", "season": "Spring, summer ", "notes": "Top Notes: BergamotMiddle (Heart) Notes: Orange, Limonene, and RoseBase Notes: Coconut, Vanilla, White Musk, Dry Wood, and Gourmand notes", "category": ["Gourmand", "Citrus", "Chypre", "Fruity", "Sweet"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": "EDP"}]
    if len(_disk_db) >= len(_seed_db) and len(_disk_db) > 0:
        st.session_state["fragrances_db"] = _disk_db
    elif len(_disk_db) > 0 and len(_disk_db) >= 50:
        # disk has a real vault even if slightly smaller than seed
        st.session_state["fragrances_db"] = _disk_db
    else:
        st.session_state["fragrances_db"] = list(_seed_db)
        # If disk was empty/thin, immediately persist the full seed so Cloud keeps it
        try:
            save_persisted_data(force=True)
        except Exception:
            pass
else:
    # Session already has a vault - never let it stay empty if seed/disk has bottles
    ...
    if _sess_n < 20:
        ...
        if len(_disk_db) >= 20:
            st.session_state["fragrances_db"] = _disk_db
        elif len(_seed_db) >= 20:
            st.session_state["fragrances_db"] = list(_seed_db)

# Frozen full sanctuary seed (for Restore seed button in Vault)
SANCTUARY_SEED_DB = [{"name": "8th Wonder", "brand": "French Avenue", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Cardamom, Pink Pepper, Candy Apple / Heart - Liquor, Dates, Boozy notes, Davana, Osmanthus / Base - Myrrh, Benzoin, Styrax, Amber Xtreme, Labdanum, Patchouli", "category": ["Oriental", "Spicy", "Sweet", "Boozy", "Chypre", "Woody"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Ajwad", "brand": "Lattafa", "gender": "Unisex", "season": "Versatile (cooler preferred)", "notes": "Fruity-woody-oriental (pineapple/rose/oud-leaning)", "category": ["Oriental", "Woody", "Fruity", "Floral", "Oud"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Angham", "brand": "Lattafa", "gender": "Unisex (leans feminine)", "season": "Fall, Winter", "notes": "Top - Ginger, Mandarin, Pink Pepper / Heart - Lavender, Praline, Cacao, Jasmine / Base - Vanilla, Amber, Musk", "category": ["Gourmand", "Spicy", "Sweet", "Aromatic", "Citrus"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Ansaam Gold", "brand": "Lattafa", "gender": "Female/Unisex", "season": "Fall, Winter", "notes": "Top - Mandarin Orange, Pear / Heart - Sweet Notes, Jasmine, Rose / Base - Musk, Vanilla, Raspberry", "category": ["Fruity", "Floral", "Sweet", "Citrus", "Gourmand"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Asad", "brand": "Lattafa", "gender": "Male", "season": "Fall, Winter", "notes": "Top - Black Pepper, Tobacco, Pineapple / Heart - Patchouli, Coffee, Iris / Base - Vanilla, Amber, Dry Woods, Benzoin, Labdanum", "category": ["Woody", "Spicy", "Oriental", "Gourmand", "Fruity", "Chypre"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Badee Al Oud Noble Blush", "brand": "Lattafa", "gender": "Female", "season": "Fall, Winter", "notes": "Top - Rose Milk / Heart - Meringue, Almond / Base - Vanilla, Musk, Sandalwood", "category": ["Floral", "Gourmand", "Sweet", "Creamy", "Woody", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Bahiya Garnet", "brand": "Arabiyat Prestige", "gender": "Female-leaning", "season": "Fall, Winter", "notes": "Top - Cherry, Mandarin, Mango, Pear, Bergamot / Heart - Amber, Fig, Jasmine / Base - Amber, Vanilla, Sandalwood, Musk", "category": ["Fruity", "Oriental", "Sweet", "Citrus", "Woody", "Chypre", "Creamy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Banat Dubai", "brand": "Le Chameau", "gender": "Female", "season": "Spring, fall", "notes": "Top - Jasmine, Bergamot, Peony / Heart - Pineapple, Peach, Plum / Base - Musk, Patchouli, Sandalwood", "category": ["Floral", "Fruity", "Woody", "Citrus", "Chypre"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Berries Cream Macaron", "brand": "Arabiyat Sugar", "gender": "Female", "season": "Spring-Fall", "notes": "Top Notes: Juicy lycheeHeart (Middle) Notes: Raspberry, maltol (confectionary sweetness), and jasmineBase Notes: Ambroxan, ambergris (or dry amber), and evernyl", "category": ["Gourmand", "Fruity", "Sweet", "Amber", "Floral", "Oriental"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Bint Hooran", "brand": "Ard Al Zaafaran", "gender": "Female", "season": "Fall, Winter", "notes": "Top - Almond, Coffee, Ylang Ylang / Heart - Jasmine, Rose, Tuberose / Base - Vanilla, Musk, Tonka, Woody/Cacao", "category": ["Gourmand", "Floral", "Oriental", "Sweet", "Vanilla", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Boulevard of New York", "brand": "Le Chameau", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Roasted Coffee Beans / Heart - Praline, Rose / Base - Oakmoss, Cedar, Amber", "category": ["Gourmand", "Woody", "Chypre", "Fougere", "Sweet"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Cafe Bliss", "brand": "Mamlakat Al Oud", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Black Coffee, Amaretto Liquor / Heart - Vanilla Ice Cream, Speculoos / Base - Vanilla Pods, Brown Sugar, Grey Amber", "category": ["Gourmand", "Sweet", "Boozy", "Vanilla", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Cafe Latte", "brand": "Khadlaj", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Coffee, Sweet Almond, Milk / Heart - Vanilla, Ice Cream Accord, Amber / Base - Vanilla, Almond Cream, Caramel", "category": ["Gourmand", "Sweet", "Creamy", "Vanilla", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Caramel Chocolate Macaron", "brand": "Arabiyat Sugar", "gender": "Female/Unisex", "season": "Fall-Winter", "notes": "Top Notes: Caramel, Coumarin (providing a sweet, warm, almond-vanilla nuance)Middle / Heart Notes: Honey, Soft Floral NotesBase Notes: Musk", "category": ["Gourmand", "Sweet", "Fougere", "Vanilla", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Caramello", "brand": "Al Rehab", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Pistachio, Almond / Heart - Jasmine, Heliotrope / Base - Caramel, Vanilla, Sandalwood", "category": ["Gourmand", "Sweet", "Floral", "Woody", "Creamy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Chocomusk", "brand": "Al Rehab", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Warm Spicy, Amber / Heart - Sweet, Powdery, Vanilla / Base - Chocolate, Musky, Cocoa", "category": ["Gourmand", "Sweet", "Powdery", "Musky", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Chocomusk Marshmallow", "brand": "Al Rehab", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Marshmallow, Strawberry / Heart - Cocoa, Vanilla / Base - Sweet Musk", "category": ["Gourmand", "Sweet", "Fruity", "Vanilla", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Chocomusk Vanilla", "brand": "Al Rehab", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Chocolate / Heart - Vanilla / Base - Musk", "category": ["Gourmand", "Sweet", "Vanilla", "Animalic", "Musky"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Club De Nuit Women", "brand": "Armaf", "gender": "Female", "season": "Spring, Fall", "notes": "Top - Apple, Citrus / Heart - Rose, Jasmine / Base - Vanilla, Musk", "category": ["Floral", "Fruity", "Fresh", "Citrus", "Gourmand", "Sweet", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Coconut Chiffon", "brand": "Arabiyat Sugar", "gender": "Female/Unisex", "season": "Spring-Summer", "notes": "Top Notes: CoconutMiddle (Heart) Notes: Coconut, JasmineBase Notes: Vanilla, Butter, Cooked Sugar (Caramel), Musk", "category": ["Gourmand", "Sweet", "Fresh", "Creamy", "Floral", "Fruity"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Confections", "brand": "Paris Corner", "gender": "Female/Unisex", "season": "Fall-Winter", "notes": "Top Notes: Pear and Whipped CreamHeart (Middle) Notes: Cashmeran, Jasmine, and Ylang-YlangBase Notes: Marshmallow, Vanilla, and Sandalwood", "category": ["Gourmand", "Sweet", "Creamy", "Floral", "Woody"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Cookie Bite", "brand": "Gulf Orchid", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Cookie, Butter / Heart - Vanilla, Musk / Base - Caramel, Amber", "category": ["Gourmand", "Sweet", "Creamy", "Vanilla", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Coral (Ana Abiyedh Coral)", "brand": "Lattafa", "gender": "Unisex (leans feminine)", "season": "Spring, Summer", "notes": "Top - Watermelon, Peach, Orange / Heart - Coconut, White Flowers / Base - Musk, Vanilla, Amber", "category": ["Fruity", "Fresh", "Sweet", "Citrus", "Gourmand", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Cotton Blush", "brand": "Arabiyat Sugar", "gender": "Female", "season": "Spring, summer", "notes": "Top Notes: Strawberry, Raspberry, CoconutHeart (Middle) Notes: Marshmallow, Peony, RoseBase Notes: Vanilla, Amber, Musk", "category": ["Floral", "Fruity", "Gourmand", "Sweet", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Cotton Candy Delicacy", "brand": "Armaf", "gender": "Unisex", "season": "Spring, Summer", "notes": "Top Notes: Raspberry, Pink Pepper, and CocoaHeart (Middle) Notes: Jasmine and RoseBase Notes: Vanilla, Benzoin Resinoid, and Cedarwood", "category": ["Gourmand", "Fruity", "Floral", "Oriental", "Spicy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Cream Velvet", "brand": "Khadlaj", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top Notes: Creamy Butter and Golden CaramelMiddle (Heart) Notes: Honey, Tonka Bean, and JasmineBase Notes: Smooth Vanilla, Amber, and Soft Musk", "category": ["Gourmand", "Sweet", "Floral", "Creamy", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Creme of Clouds", "brand": "Fragrance World", "gender": "Unisex", "season": "Fall, Winter, spring", "notes": "Top Notes: Coconut milk, Creamy milk, Burnt sugarHeart (Middle) Notes: Whipped cream, Vanilla, ChocolateBase Notes: Vanilla, White musk, Burnt sugar", "category": ["Gourmand", "Sweet", "Creamy", "Fruity", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Creme Caramel", "brand": "Mamlakat Al Oud", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Caramel, Vanilla Flower / Heart - Dulce de Leche, Cotton Candy, Frangipani, White Flowers / Base - Vanilla Pod, Tonka Bean, Musk", "category": ["Gourmand", "Sweet", "Vanilla", "Animalic", "Musky"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Cup Cake", "brand": "Al Rehab", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Citrus, Amber / Heart - Vanilla Cake / Base - Vanilla, Amber", "category": ["Gourmand", "Sweet", "Citrus", "Vanilla", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Dalal", "brand": "Lattafa", "gender": "Female", "season": "Spring", "notes": "Top - Apple (Golden Delicious), Mandarin / Heart - Jasmine, Ylang-Ylang, Orange Flower / Base - Vanilla, Musk, Oakmoss", "category": ["Floral", "Fruity", "Fresh", "Citrus", "Chypre", "Fougere", "Gourmand"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Dulzura", "brand": "Paris Corner", "gender": "Female", "season": "Fall-Winter", "notes": "Top - Black pepper, buttermilk / Heart - Cake, vanilla, cream / Base - Amber, musk", "category": ["Gourmand", "Sweet", "Creamy", "Spicy", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Eclaire", "brand": "Lattafa", "gender": "Female", "season": "Fall, Winter", "notes": "Top - Caramel, Milk, Sugar / Heart - Honey, White Flowers / Base - Vanilla, Praline, Musk", "category": ["Gourmand", "Sweet", "Vanilla", "Animalic", "Creamy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Eclaire Banoffi", "brand": "Lattafa", "gender": "Unisex/Female", "season": "Fall-Winter", "notes": "Top Notes: Banana Cream, Dulce de LecheHeart (Middle) Notes: Whipped Cream, VanillaBase Notes: Praline, Biscuit, Musk", "category": ["Gourmand", "Sweet", "Fruity", "Vanilla", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Elyssia Aura", "brand": "Riiffs", "gender": "Unisex", "season": "Fall, Winter (versatile to cooler)", "notes": "Top - Cinnamon, Orange, Nutmeg / Heart - Vanilla Cream, Cognac, Cocoa / Base - Bourbon Vanilla, Cedarwood, Patchouli", "category": ["Gourmand", "Spicy", "Woody", "Boozy", "Citrus"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Elyssia Scarlet", "brand": "Riiffs", "gender": "Female", "season": "Spring-Summer / versatile", "notes": "Top - Black Cherry, Pink Pepper / Heart - Leather, Cream, Benzoin / Base - Vanilla Absolute, Cashmeran, Amber, Iso E Super", "category": ["Fruity", "Leather", "Sweet", "Gourmand", "Oriental", "Spicy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Emaan", "brand": "Lattafa", "gender": "Female/Unisex", "season": "Fall, Winter", "notes": "Top - Orange Blossom, Black Currant, Bergamot / Heart - Tuberose, Jasmine, Marigold / Base - Musk, Vanilla, Cedarwood, Patchouli", "category": ["Floral", "Fruity", "Citrus", "Woody", "Chypre", "Gourmand"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Emir Pear Potion", "brand": "Paris Corner", "gender": "Unisex", "season": "Spring", "notes": "Top - Pear, Apple / Heart - Caramel, Jasmine / Base - Raspberry, Musk", "category": ["Fruity", "Gourmand", "Sweet", "Floral", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Empire Najm by Risala", "brand": "Risala", "gender": "Unisex (female-leaning)", "season": "Fall, Winter", "notes": "Top - Mango, Ginger, Lemon, Red Berries / Heart - Coumarin, Jasmine, Cedar / Base - Cypriol, Amber, Musk, Oud", "category": ["Fruity", "Oriental", "Woody", "Floral", "Fougere", "Spicy", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Empire Victor", "brand": "Khadlaj", "gender": "Unisex", "season": "Fall, Winter,spring", "notes": "Top Notes: Lemon, BergamotMiddle (Heart) Notes: Caramel, JasmineBase Notes: Vanilla, Musk (some variations also list sandalwood)", "category": ["Gourmand", "Floral", "Fruity", "Sweet", "Citrus", "Woody", "Chypre"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Energize", "brand": "Heroes", "gender": "Male", "season": "Spring, Summer", "notes": "Top - Citrus, Aromatic Herbs / Heart - Light Spices / Base - Woods, Musk", "category": ["Fresh", "Citrus", "Aromatic", "Animalic", "Musky", "Spicy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Entice Extrait", "brand": "Vurv", "gender": "Female", "season": "Cooler / evening", "notes": "Top Notes: Citrus and fresh floral elements (including aromatic nuances like lilac and bergamot)Heart / Middle Notes: Rich bouquet of floral accordsBase Notes: Warm amber, sensual musk, and woody elements", "category": ["Oriental", "Sweet", "Fruity", "Citrus", "Aromatic", "Chypre", "Amber", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Entice Ruby", "brand": "Vurv", "gender": "Female", "season": "Spring-Summer / versatile", "notes": "Top Notes: Red fruits, Bergamot, MandarinHeart (Middle) Notes: Roses, Jasmine, White flowersBase Notes: Amber, Musk, Soft woods, Vanilla", "category": ["Fruity", "Floral", "Citrus", "Chypre", "Gourmand", "Sweet"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Eshal Vanilla", "brand": "Paris Corner", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top Notes: Sugar, Sweet NotesHeart (Middle) Notes: Jasmine, RoseBase Notes: Vanilla, Caramel, Musk", "category": ["Gourmand", "Floral", "Sweet", "Vanilla", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Espada Intense", "brand": "Le Chameau", "gender": "Male", "season": "Cooler seasons / evening", "notes": "Deeper/intensified version of Espada Prime", "category": ["Woody", "Spicy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Espada Prime", "brand": "Le Chameau", "gender": "Male", "season": "Spring-Summer / versatile", "notes": "Top Notes (Head): Ruby, mandarin orange, grapefruit, and peppermint (mint)Middle Notes (Heart): Rose absolute, cinnamon, and mixed spicesBase Notes: Leather, patchouli, whitewoods, and amber", "category": ["Fresh", "Woody", "Spicy", "Citrus", "Leather", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Essences", "brand": "Sara Debai", "gender": "Female", "season": "Spring-Summer", "notes": "Top - Heliotrope, orchid, tangerine / Heart - Gourmand accord, tropical fruits / Base - Vanilla, musk, sandalwood", "category": ["Floral", "Gourmand", "Fruity", "Woody", "Creamy", "Powdery"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Eternal Vanille", "brand": "Lattafa", "gender": "Unisex", "season": "Year-round (best Spring/Fall)", "notes": "Top - Blackberry / Heart - Cocoapulse, Vanilla Caviar, Cacao / Base - Akigalawood, Tonka Bean, Ambrofix, Cedarwood, Benzoin, Musk", "category": ["Gourmand", "Woody", "Sweet", "Oriental", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Fakhama", "brand": "Amaran", "gender": "Unisex/Male", "season": "Cooler seasons", "notes": "Top Notes: Cinnamon, nutmeg, and vanillaMiddle (Heart) Notes: Dates, tuberose, praline, and mahonialBase Notes: Musk, tonka bean, amberwood, myrrh, benzoin, and akigalawood", "category": ["Oriental", "Woody", "Gourmand", "Spicy", "Sweet", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Fakhar Black", "brand": "Lattafa", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Dark Fruits, Spices / Heart - Woody / Base - Vanilla, Musk", "category": ["Fruity", "Woody", "Spicy", "Gourmand", "Sweet", "Vanilla", "Animalic", "Musky"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Fakhar Gold", "brand": "Lattafa", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Tuberose, Salt / Heart - Amber, Tonka / Base - Cedarwood, Vetiver, Labdanum", "category": ["Floral", "Woody", "Oriental", "Chypre", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Fakhar Silver", "brand": "Lattafa", "gender": "Unisex", "season": "Spring , summer", "notes": "Top Notes: Apple, Bergamot, GingerHeart (Middle) Notes: Lavender, Sage, Juniper Berries, GeraniumBase Notes: Tonka Bean, Amberwood, Cedar, Vetiver", "category": ["Gourmand", "Woody", "Aromatic", "Citrus", "Amber", "Chypre"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Falak", "brand": "Nusuk", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Brown Sugar, Caramel, Biscuit / Heart - Toffee, Vanilla Bean, Amber / Base - White Musk, Praline", "category": ["Gourmand", "Sweet", "Vanilla", "Amber", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Fatima Pink", "brand": "Zimaya", "gender": "Female", "season": "Spring, Fall", "notes": "Top - Rhubarb, Bergamot, Grapefruit, Nutmeg / Heart - Rose, Jasmine / Base - Musk, Vanilla, Vetiver, Ambergris", "category": ["Floral", "Fruity", "Fresh", "Citrus", "Amber", "Chypre", "Gourmand"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Fire on Ice", "brand": "Lattafa", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top Notes: Black raspberry, cinnamon, cognac (liquor)Middle (Heart) Notes: Frozen rose petals, caramel, mossBase Notes: Oakwood, myrrh, cedarwood, ambroxan", "category": ["Gourmand", "Boozy", "Fruity", "Woody", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "French Vanilla", "brand": "Al Rehab", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Vanilla / Heart - Creamy Sweet / Base - Vanilla, Musk", "category": ["Gourmand", "Sweet", "Creamy", "Vanilla", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "French Vanilla Latte", "brand": "Arabiyat Sugar", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Nutella, Cardamom, Rum / Heart - Cocoa, Coconut, White Flowers, Lily of the Valley / Base - Sandalwood, Ambergris, Musk", "category": ["Gourmand", "Sweet", "Amber", "Woody", "Creamy", "Fruity", "Spicy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Ghaliya", "brand": "Zakat", "gender": "Unisex/Female", "season": "Fall-Winter", "notes": "Top Notes: Orange, Lemon, Apple, and BergamotMiddle (Heart) Notes: Caramel, Muguet (Lily of the Valley), Cedarwood, Jasmine Sambac, Bulgarian Rose, and TuberoseBase Notes: Tonka Bean, Amber, Musk, Cocoa, Sandalwood, and Patchouli", "category": ["Oriental", "Floral", "Oud", "Woody", "Citrus", "Gourmand", "Chypre"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Ghubar Al Dhahab", "brand": "Sahari", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Cinnamon, Pear, Mandarin, Floral notes / Heart - Jasmine Sambac, Orange Blossom / Base - White Musk, Vanilla, Tonka Bean, Coffee, Patchouli", "category": ["Floral", "Spicy", "Sweet", "Citrus", "Gourmand"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Habik (Women's Version)", "brand": "Lattafa", "gender": "Female", "season": "Spring, Summer", "notes": "Top - Pear, Bergamot / Heart - Lily of the Valley, Jasmine, Freesia / Base - Musk, Amber, Oakmoss", "category": ["Floral", "Fresh", "Fruity", "Chypre", "Citrus", "Fougere", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Hareem Al Sultan Gold", "brand": "Khadlaj", "gender": "Female", "season": "Spring, Summer", "notes": "Top - Bergamot, Jasmine, Peony / Heart - Pineapple, Peach, Plum / Base - Musk, Sandalwood, Patchouli", "category": ["Floral", "Fruity", "Fresh", "Woody", "Chypre", "Citrus"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Hawas Diva", "brand": "Rasasi", "gender": "Female", "season": "Fall, Winter", "notes": "Top - Red Fruits, Rhubarb, Lychee / Heart - Rose, Frankincense, Cedar / Base - Vanilla, Musk, Ambergris", "category": ["Fruity", "Floral", "Woody", "Amber", "Oriental", "Gourmand", "Smoky"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Hawas Eclat (Eclat Hawas)", "brand": "Rasasi", "gender": "Female", "season": "Spring, Fall", "notes": "Top - Litchi/Lychee, Bergamot, Pear, Pistachio / Heart - Rose, Incense / Base - Vanilla, Amber, Musk, Woody Notes", "category": ["Fruity", "Floral", "Woody", "Gourmand", "Oriental", "Chypre", "Citrus"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Hawas Elixir", "brand": "Rasasi", "gender": "Unisex", "season": "Fall-Winter", "notes": "Top - Mint, bergamot, artemisia / Heart - Dark chocolate, lavender, benzoin / Base - Vanilla, tonka bean, white musk", "category": ["Gourmand", "Fresh", "Sweet", "Aromatic", "Chypre", "Citrus", "Fougere"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Hawas Ice", "brand": "Rasasi", "gender": "Male", "season": "Spring , summer", "notes": "Top - Apple, Italian Lemon, Sicilian Bergamot, Star Anise / Heart - Plum, Orange Blossom, Cardamom / Base - Musk, Moss, Driftwood, Amber", "category": ["Fresh", "Fruity", "Aromatic", "Citrus", "Floral", "Spicy", "Chypre"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Hawas London", "brand": "Rasasi", "gender": "Unisex", "season": "Fall, Spring", "notes": "Top - Pink Pepper, Saffron, Pear / Heart - Rose, Frankincense, White Flowers / Base - Blonde Woods, Vanilla, Amber, Musk", "category": ["Floral", "Woody", "Spicy", "Oriental", "Gourmand", "Smoky", "Sweet"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Hawas Pink", "brand": "Rasasi", "gender": "Female", "season": "Fall, Winter", "notes": "Top - Cinnamon, Nutmeg, Neroli / Heart - Marshmallow, Tuberose, Orange Blossom / Base - Cotton Candy, Vanilla, Tonka Bean", "category": ["Gourmand", "Floral", "Sweet", "Citrus", "Spicy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Hawwa Red", "brand": "Zimaya", "gender": "Female", "season": "Fall, Winter", "notes": "Top - Cassis, Strawberry, Raspberry, Orange / Heart - Black Currant, Grapefruit, Peach, Lily / Base - Musk, Vanilla, Patchouli", "category": ["Fruity", "Floral", "Sweet", "Citrus", "Gourmand", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Haya", "brand": "Lattafa", "gender": "Female", "season": "Fall, Winter", "notes": "Top - Champagne, Strawberry, Rose, Tangerine, Blood Orange / Heart - Gardenia, Jasmine, Vanilla Orchid / Base - Amber, Sandalwood", "category": ["Floral", "Fruity", "Sweet", "Woody", "Boozy", "Citrus"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Heavy Cream", "brand": "Phlur", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Marshmallow, Sugar, Citrus / Heart - Coconut, Jasmine / Base - Whipped Cream, Vanilla, Caramel", "category": ["Gourmand", "Sweet", "Citrus", "Floral", "Fruity"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Her Confessions", "brand": "Lattafa", "gender": "Female", "season": "Fall, Winter", "notes": "Top - Cinnamon / Heart - Tuberose, Jasmine, Incense / Base - Vanilla, Musk, Tonka", "category": ["Floral", "Spicy", "Oriental", "Gourmand", "Smoky"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "His Confessions", "brand": "Lattafa", "gender": "Male", "season": "Fall, Winter", "notes": "Top - Lavender, Cinnamon, Mandarin / Heart - Iris, Benzoin, Cypress, Mahonial / Base - Vanilla, Tonka, Amber, Incense, Cedarwood, Patchouli", "category": ["Woody", "Spicy", "Oriental", "Aromatic", "Citrus", "Fougere"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Island Bliss", "brand": "Armaf", "gender": "Unisex", "season": "Spring, Summer", "notes": "Top - Tropical Fruits, Coconut / Heart - Sweet / Base - Musk", "category": ["Fruity", "Fresh", "Sweet", "Animalic", "Musky"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Khair Men", "brand": "Paris Corner", "gender": "Male/Unisex", "season": "Fall, Winter", "notes": "Top - Davana, Bergamot, Pink Pepper / Heart - Agarwood (Oud), Amber, Rosemary / Base - Leather, Vetiver, Musk", "category": ["Woody", "Oud", "Spicy", "Aromatic", "Chypre", "Citrus"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Khamrah Dukhan", "brand": "Lattafa", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Spices, Pimento, Mandarin / Heart - Incense, Labdanum, Orange Blossom, Patchouli / Base - Tobacco, Praline, Amber, Tonka Bean, Benzoin", "category": ["Oriental", "Spicy", "Sweet", "Citrus", "Smoky", "Chypre"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Khamrah Original", "brand": "Lattafa", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Cinnamon, Nutmeg, Bergamot / Heart - Dates, Praline, Tuberose, Mahonial / Base - Vanilla, Tonka Bean, Amberwood, Myrrh, Benzoin, Akigalawood", "category": ["Oriental", "Spicy", "Sweet", "Gourmand", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Khamrah Qahwa", "brand": "Lattafa", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Cinnamon, Cardamom, Ginger / Heart - Praline, Candied Fruits, White Flowers / Base - Coffee, Vanilla, Tonka Bean, Benzoin, Musk", "category": ["Gourmand", "Spicy", "Sweet", "Oriental", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Khamrah Waha", "brand": "Lattafa", "gender": "Unisex", "season": "Fall-Winter", "notes": "Spicy-sweet (date, cinnamon, vanilla family)", "category": ["Oriental", "Spicy", "Sweet", "Gourmand", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Kiaana Angel", "brand": "Afnan", "gender": "Female", "season": "Spring, summer", "notes": "Top Notes: Pistachio Gelato (or Ice Cream), Italian BergamotMiddle (Heart) Notes: Jasmine, Raspberry, White Peach, PearBase Notes: Cedarwood, Sandalwood, Tonka Bean", "category": ["Gourmand", "Floral", "Fruity", "Woody", "Creamy", "Chypre"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Le Parfum", "brand": "Blue for Men", "gender": "Male/Unisex", "season": "Fall, Winter", "notes": "Top - Cardamom / Heart - Lavender, Iris / Base - Vanilla, Oriental Woods", "category": ["Woody", "Oriental", "Spicy", "Aromatic", "Fougere", "Gourmand"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Lemon Sorbet", "brand": "Arabiyat Sugar", "gender": "Unisex", "season": "Spring, summer", "notes": "Top Notes: Zesty lemon and a subtle nuance of rumMiddle/Heart Notes: Sweet gourmand and sorbet cream accordBase Notes: Creamy vanilla and soft musk", "category": ["Gourmand", "Fruity", "Oriental", "Creamy", "Sweet", "Vanilla", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Love & Peace", "brand": "Lattafa", "gender": "Unisex/Female", "season": "Spring-Fall", "notes": "Top Notes: Almond, Black Currant, and BergamotMiddle (Heart) Notes: Rose and TuberoseBase Notes: Sandalwood, Vanilla, and Heliotrope", "category": ["Floral", "Sweet", "Gourmand", "Woody", "Chypre", "Citrus"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Luxe Chic", "brand": "Maison Alhambra", "gender": "Female/Unisex", "season": "Spring, Fall", "notes": "Top - Tangerine, Freesia / Heart - Lily of the Valley, Jasmine, Rose / Base - Musk, Sandalwood, Amber", "category": ["Floral", "Fresh", "Woody", "Creamy", "Amber", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Maitha Oil (Attar)", "brand": "Lattafa", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Anise / Heart - Caramel / Base - Vanilla, Tonka Bean, Musk", "category": ["Gourmand", "Sweet", "Vanilla", "Animalic", "Aromatic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Majestic Supreme", "brand": "Le Falcone", "gender": "Women/Unisex", "season": "Fall-Winter / versatile", "notes": "Top - Rose, peony, pink pepper / Heart - Raspberry blossom, jasmine / Base - Amber, papyrus, tonka, vanilla", "category": ["Floral", "Sweet", "Fruity", "Gourmand", "Spicy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Malika", "brand": "Nusuk", "gender": "Female", "season": "Fall , winter ", "notes": "Top Notes: Ozonic notes, apple, aldehydic notes, tarragon, bergamot, and orangeHeart Notes: Lily of the valley, jasmine, rose, carnation, orchid, and honeysuckleBase Notes: Musk, amber, vanilla, sandalwood, cedarwood, and orris", "category": ["Floral", "Oriental", "Citrus", "Woody", "Gourmand", "Sweet"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Mango Affogato", "brand": "Arabiyat Sugar", "gender": "Unisex", "season": "Spring-Summer / year-round", "notes": "Top - Mango, nutmeg, clove / Heart - Leather, saffron, amber, moss / Base - Akigalawood, patchouli, vetiver, cypriol", "category": ["Fruity", "Woody", "Spicy", "Oriental", "Leather", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Mango Ice", "brand": "Gulf Orchid", "gender": "Unisex", "season": "Spring-Summer", "notes": "Top Notes: Mango, Lemon, Ginger, RhubarbHeart (Middle) Notes: White Flowers, Amber, LicoriceBase Notes: Musk, Vanilla, Caramel, Chestnut", "category": ["Fruity", "Fresh", "Gourmand", "Sweet", "Spicy", "Vanilla", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Marshmallow Blush", "brand": "Paris Corner", "gender": "Female/Unisex", "season": "Fall, Winter", "notes": "Top - Marshmallow, Sweet / Heart - Fruity / Base - Vanilla, Musk", "category": ["Gourmand", "Sweet", "Fruity", "Vanilla", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Marshmallow Dreams", "brand": "NatureWell", "gender": "Female", "season": "Fall, winter", "notes": "Top Notes: Lemon Sugar & MarshmallowMid Notes: Coconut CreamBase Notes: Vanilla Mousse & Whipped Cream", "category": ["Gourmand", "Sweet", "Fruity", "Vanilla", "Citrus"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Marshmallows Kiss", "brand": "Mamlakat Al Oud", "gender": "Unisex", "season": "Fall, Winter, Spring", "notes": "Top - Strawberry, Blackberry (or Caramel/Milk) / Heart - Jasmine, Rose, Marshmallow, Vanilla, Honey / Base - Vanilla, Musk, Praline, Tonka", "category": ["Gourmand", "Floral", "Sweet", "Fruity", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Mayar", "brand": "Lattafa", "gender": "Female", "season": "Spring, Summer", "notes": "Top - Lychee, Raspberry, Violet Leaf / Heart - Peony, White Rose, Jasmine / Base - Musk, Vanilla", "category": ["Floral", "Fruity", "Fresh", "Gourmand", "Powdery", "Sweet"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Mayar Cherry Intense", "brand": "Lattafa", "gender": "Female", "season": "Fall, Winter", "notes": "Top - Strawberry, Bergamot / Heart - Cherry Jam, Cacao / Base - Vanilla, Amber, Patchouli", "category": ["Fruity", "Gourmand", "Sweet", "Chypre", "Citrus"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Milano", "brand": "Valentine", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Raspberry, Peach, Bergamot / Heart - Rose, Jasmine, Orange Blossom / Base - Vanilla, Amber, Woods", "category": ["Floral", "Fruity", "Sweet", "Citrus", "Chypre", "Gourmand"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Momento", "brand": "Riiffs", "gender": "Unisex", "season": "Winter", "notes": "Top Notes: Sugar, Saffron, and Mandarin give a sweet and citrus opening.Heart (Middle) Notes: Tonka Bean, Damask Rose, and Agarwood (Oud) create a floral and rich center.Base Notes: Caramel, Amberwood, and Cedar leave a warm and woody finish.", "category": ["Aromatic", "Citrus", "Oriental", "Oud", "Sweet", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Mystique", "brand": "Armaf", "gender": "Female", "season": "Fall, Winter", "notes": "Top - Pear, Tangerine, Bergamot, Orange / Heart - Vanilla, Strawberry, Mimosa, Rose, Ylang Ylang, Jasmine, Passionfruit / Base - Vanilla, Coffee, Tonka Bean, Patchouli, Vetiver", "category": ["Floral", "Fruity", "Gourmand", "Citrus", "Woody"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Mystique Charm", "brand": "Dorall Collection", "gender": "Female", "season": "Spring, summer", "notes": "Top Notes: Clementine, Cappuccino, Cactus, Pepper, and BlackberryMiddle (Heart) Notes: Mimosa, Hortensia (Hydrangea), Camellia, and OrchidBase Notes: Woody Notes, Blackberry, Musk, Amber, and Red Berries", "category": ["Sweet", "Floral", "Oriental", "Fruity", "Spicy", "Amber", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Nagham", "brand": "Atyaab", "gender": "Unisex", "season": "Winter", "notes": "Top Notes: Rose, Jasmine, and BergamotMiddle (Heart) Notes: Amber, Vetiver, and Candied Fruit (such as sweet strawberries and cherries)Base Notes: Vanilla, Cedarwood, and Sandalwood", "category": ["Floral", "Woody", "Oriental", "Sweet", "Chypre", "Citrus"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Nasmaat", "brand": "Lattafa", "gender": "Unisex", "season": "Spring, Fall", "notes": "Top - Blackcurrant, Apricot, Pineapple / Heart - Magnolia, Cyclamen, Jasmine, Orange Blossom, Rose / Base - Vanilla, Cashmeran, Caramel, Sandalwood", "category": ["Floral", "Fruity", "Sweet", "Gourmand", "Woody"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Natural Intense Body Spray", "brand": "Mayar", "gender": "Female", "season": "Fall, Winter", "notes": "Top - Sweet Gourmand / Heart - Vanilla / Base - Musk", "category": ["Gourmand", "Sweet", "Vanilla", "Animalic", "Musky"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Nebras", "brand": "Lattafa", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Red Berries, Mandarin Orange / Heart - Vanilla, Cacao, Rose / Base - Sugar, Tonka Bean, Amber, Musk", "category": ["Gourmand", "Fruity", "Sweet", "Citrus", "Vanilla", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Nebras Elixir", "brand": "Lattafa", "gender": "Unisex", "season": "Fall, Winter, Mild Spring", "notes": "Top - Milk Candy, Whipped Cream / Heart - Sugar Cane, Heliotrope / Base - Vanilla, Ambroxan, Musk", "category": ["Gourmand", "Sweet", "Amber", "Creamy", "Floral"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Nero Xtravagant", "brand": "Valentine (Urban Collection)", "gender": "Male/Unisex (leans masculine)", "season": "Fall, Winter (versatile)", "notes": "Top - Calabrian Bergamot, Espresso Coffee Accord / Heart - Coffee / Base - Vetiver", "category": ["Woody", "Fresh", "Aromatic", "Chypre", "Citrus", "Gourmand"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Noor", "brand": "Riiffs", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top Notes: Caramel and milkMiddle (Heart) Notes: Gourmand accord and lily of the valleyBase Notes: Vanilla, musk, and praline", "category": ["Gourmand", "Floral", "Sweet", "Vanilla", "Animalic", "Creamy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Nuha Vanilla Pearl", "brand": "Khadlaj", "gender": "Female", "season": "Fall, Winter", "notes": "Top - Blackcurrant, Strawberry, Freesia / Heart - Raspberry, Magnolia, Cashmere Wood / Base - Vanilla, Caramel, Moss", "category": ["Fruity", "Gourmand", "Floral", "Sweet", "Woody"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Nyla", "brand": "Arabiyat Prestige", "gender": "Female", "season": "Spring, Summer", "notes": "Top Notes: Coconut, Peach, Bergamot, and Mandarin (offering a fresh, sun-kissed fruit opening)Heart Notes: Tiare Flower, White Flowers, Jasmine, and Rose (providing an exotic and romantic floral bouquet)Base Notes: White Musk, Patchouli, Sandalwood, and Heliotrope (delivering a creamy, soft, and sensual woody finish)", "category": ["Floral", "Fruity", "Fresh", "Citrus", "Woody", "Creamy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Nyla Vanielle", "brand": "Arabiyat Prestige", "gender": "Female", "season": "Fall, Winter", "notes": "Top - Jasmine, Vanilla Bean / Heart - Caramel, Amber / Base - Musk, Tonka Bean, Vanilla", "category": ["Gourmand", "Sweet", "Floral", "Vanilla", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Obsidian", "brand": "French Avenue", "gender": "Unisex/Male", "season": "Fall-Winter", "notes": "Top Notes: Aldehydes, Grapefruit, BergamotHeart Notes: Myrrh, Jasmine, LabdanumBase Notes: Vanilla, Amber, Tonka Bean", "category": ["Woody", "Oriental", "Smoky", "Chypre", "Citrus", "Floral", "Gourmand"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Odyssey Candee", "brand": "Armaf", "gender": "Female-leaning", "season": "Fall, Winter", "notes": "Top - Strawberry, Raspberry, Peach, Bergamot / Heart - Caramel, Jasmine / Base - Patchouli, Musk, Amber", "category": ["Fruity", "Gourmand", "Sweet", "Chypre", "Citrus", "Floral"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Odyssey Marshmallow", "brand": "Armaf", "gender": "Unisex", "season": "Spring, Fall, Winter", "notes": "Top - Apple, Lemon, Coconut, Peony, Lily of the Valley / Heart - Strawberry, Peach, Raspberry, Apricot, Marshmallow, Orange Blossom / Base - Vanilla, Praline, Tonka, Amber, Musk, Mascarpone", "category": ["Gourmand", "Fruity", "Sweet", "Floral", "Citrus"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Opulent Dubai", "brand": "Lattafa", "gender": "Unisex", "season": "Spring, Summer (versatile year-round in mild climates)", "notes": "Top - Mango, Grapefruit, Lemon, Ginger / Heart - Jasmine, Cedarwood, Violet / Base - Woodsy notes, Ambergris, Benzoin, Oakmoss", "category": ["Fruity", "Woody", "Fresh", "Floral", "Amber", "Citrus", "Oriental"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Oud Mood", "brand": "Lattafa", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Rose, Saffron, Pimento / Heart - Agarwood (Oud), Caramel, Floral Notes, Patchouli / Base - Woody Notes, Amber, Resins, Incense, Musk", "category": ["Oriental", "Oud", "Woody", "Gourmand", "Smoky"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Panache Angel Dust", "brand": "Khadlaj", "gender": "Female", "season": "Spring, winter , fall", "notes": "Top Notes: Vanilla, Mandarin, and Red CurrantMiddle (Heart) Notes: Tuberose, Sandalwood, and RumBase Notes: Vanilla, Whipped Cream, Musk, and Benzoin", "category": ["Floral", "Sweet", "Powdery", "Gourmand", "Woody", "Citrus", "Creamy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Peach Velvet", "brand": "Khadlaj", "gender": "Female", "season": "Spring, Summer, Fall", "notes": "Top - Guava, Peach, Nectarine / Heart - Vanilla, Ginger, Cinnamon, Amber / Base - Caramel, Musk, Sandalwood", "category": ["Fruity", "Gourmand", "Sweet", "Spicy", "Woody", "Creamy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Pecan Butter Cookie", "brand": "Arabiyat Sugar", "gender": "Unisex/Female", "season": "Fall-Winter", "notes": "Top - Pecan, coconut milk, butter / Heart - Hazelnut, almond, roasted nuts / Base - Hazelnut, vanilla, ambergris", "category": ["Gourmand", "Sweet", "Amber", "Creamy", "Fruity"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Petra", "brand": "Lattafa", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top Notes: Plum, RumHeart (Middle) Notes: Tuberose, CoconutBase Notes: Praline, Musk, Vanilla", "category": ["Gourmand", "Fruity", "Floral", "Sweet", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Pink Velvet", "brand": "Maison Alhambra", "gender": "Female", "season": "Spring-Fall", "notes": "Top Notes: Bulgarian Rose and May RoseMiddle/Heart Notes: Turkish Rose and SaffronBase Notes: Patchouli, Tonka Bean, and Vanilla", "category": ["Floral", "Sweet", "Powdery", "Gourmand", "Oriental", "Vanilla", "Woody"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Pina Colada Musk Collection Body Spray", "brand": "Gulf Orchid", "gender": "Unisex", "season": "Spring, Summer", "notes": "Top - Pineapple, Coconut / Heart - Tropical / Base - Musk", "category": ["Fruity", "Fresh", "Sweet", "Animalic", "Musky", "Woody"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Prive Rose", "brand": "Ameerat Al Arab", "gender": "Female", "season": "Spring , summer", "notes": "Top Notes: Strawberry, Grapes, and OrangeMiddle (Heart) Notes: Rose, White Musk, Jasmine, Gardenia, Ylang-Ylang, and LilyBase Notes: Tonka Bean, Amber, and Sandalwood", "category": ["Floral", "Sweet", "Gourmand", "Fruity", "Woody", "Citrus", "Creamy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Qaed Al Fursan (Original)", "brand": "Lattafa", "gender": "Unisex (leans masculine)", "season": "Fall, Winter", "notes": "Top - Pineapple, Saffron / Heart - Balsam Fir, Jasmine / Base - Cedar, Amber, Agarwood (Oud)", "category": ["Fruity", "Woody", "Oud", "Oriental", "Floral"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Qaed Al Fursan Unlimited", "brand": "Lattafa", "gender": "Male/Unisex", "season": "Spring, Fall", "notes": "Top - Coconut, Pineapple, Citruses / Heart - Ylang-Ylang, Frangipani, Jasmine / Base - Vanilla, Musk, Sandalwood, Sweet Notes", "category": ["Fruity", "Floral", "Sweet", "Woody", "Citrus"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Qaed Al Fursan Untamed", "brand": "Lattafa", "gender": "Male/Unisex", "season": "Spring, Fall", "notes": "Top - Apple, Citrus / Heart - Floral / Base - Sweet, Woody", "category": ["Fruity", "Woody", "Fresh", "Citrus", "Sweet"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Raheeq", "brand": "Nusuk", "gender": "Unisex", "season": "Fall , winter", "notes": "Top Notes: Honey, Blood Orange, Apricot, and LemonMiddle (Heart) Notes: Caramel, Coconut, and MagnoliaBase Notes: Vanilla Absolute, Musk, and Sandalwood", "category": ["Floral", "Sweet", "Gourmand", "Citrus", "Woody", "Creamy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Raneen", "brand": "Lattafa", "gender": "Female", "season": "Fall, Winter", "notes": "Top - Fruity, Sweet / Heart - Floral / Base - Vanilla, Musk", "category": ["Floral", "Fruity", "Sweet", "Gourmand", "Vanilla", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Rave Now (for Women)", "brand": "Lattafa", "gender": "Female", "season": "Spring, Fall", "notes": "Top - Red Fruits, Orange / Heart - Marshmallow, Jasmine, Lily of the Valley / Base - Vanilla, Musk, Moss", "category": ["Fruity", "Gourmand", "Floral", "Citrus", "Sweet", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Rave Now Intense", "brand": "Lattafa", "gender": "Male/Unisex", "season": "Spring, Fall", "notes": "Top - Cucumber, Watermelon, Tangerine / Heart - Basil, Sage / Base - Sandalwood, Leather, Cedar", "category": ["Fresh", "Woody", "Aromatic", "Creamy", "Leather"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Rave Rage", "brand": "Lattafa", "gender": "Unisex (leans masculine)", "season": "Year-round", "notes": "Top - Apple, mint / Heart - Geranium, cinnamon, lavender / Base - Vanilla, Peru balsam, cedarwood, guaiac wood", "category": ["Fresh", "Woody", "Spicy", "Aromatic", "Fougere", "Gourmand", "Oriental"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Red 500", "brand": "Baraja", "gender": "Unisex/Male", "season": "Fall, Winter", "notes": "Top - Red Fruits, Spices / Heart - Sweet Notes / Base - Woody, Musk", "category": ["Fruity", "Woody", "Spicy", "Animalic", "Musky", "Sweet"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Red Velvet Delicacy", "brand": "Armaf", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Strawberry, Lemon / Heart - Whipped Sugar, Sugarberry, Frangipani / Base - Vanilla Bean, Musk, Amber", "category": ["Gourmand", "Fruity", "Sweet", "Vanilla", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Royal Men", "brand": "Al Rehab", "gender": "Male", "season": "Fall, Winter", "notes": "Top - Spicy, Citrus, Woody / Heart - Floral, Sweet / Base - Amber, Musk, Vanilla", "category": ["Woody", "Spicy", "Oriental", "Sweet", "Citrus", "Gourmand", "Vanilla", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Safa", "brand": "Nusuk", "gender": "Unisex/Female", "season": "Spring-Summer / versatile", "notes": "Top - Marshmallow, Strawberry, Lemon / Heart - Coconut, Sugar, Nectarine / Base - Vanilla, Musk, Ambroxan", "category": ["Gourmand", "Fruity", "Sweet", "Amber", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Sakeena", "brand": "Lattafa", "gender": "Female/Unisex", "season": "Fall, Winter", "notes": "Top - Passionfruit, Mandarin Orange, Ozonic Notes / Heart - Raspberry, Rose, Orange Blossom, Sea Salt / Base - Toffee, Praline, Vanilla, Musk", "category": ["Fruity", "Gourmand", "Floral", "Sweet", "Citrus", "Aquatic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Samiya", "brand": "Khadlaj", "gender": "Female", "season": "Spring , fall", "notes": "Top/Head Notes: Jasmine, Lily of the ValleyMiddle/Heart Notes: Amber, VioletBase Notes: Oud, Saffron, Sandalwood", "category": ["Floral", "Oriental", "Woody", "Powdery", "Creamy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Sceptre Malachite", "brand": "Maison Alhambra", "gender": "Unisex", "season": "Spring-Summer", "notes": "Top - Green tangerine, bergamot, blackcurrant / Heart - Aromatic + spicy notes, lavender, pink pepper, jasmine / Base - Amber, musk, woody notes, vetiver", "category": ["Fresh", "Aromatic", "Woody", "Chypre", "Citrus", "Floral"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Sensual Vanilla", "brand": "Maison Alhambra", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top Note: Bitter AlmondMiddle Notes: Vanilla, Floral NotesBase Notes: Vanilla Absolute, Tonka Bean, Sandalwood", "category": ["Oriental", "Gourmand", "Woody", "Creamy", "Sweet", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Silver", "brand": "Al Rehab", "gender": "Unisex/Male", "season": "Spring, Summer", "notes": "Top - Fresh Citrus, Metallic / Heart - Floral / Base - Musk, Sweet", "category": ["Fresh", "Citrus", "Metallic", "Animalic", "Musky"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Soft", "brand": "Al Rehab", "gender": "Unisex (leans feminine)", "season": "Fall, Winter", "notes": "Top - Citruses / Heart - Orchid, Jasmine, Vanilla, Caramel / Base - White Musk, Woody Notes, Vetiver", "category": ["Floral", "Sweet", "Gourmand", "Woody", "Citrus"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Spectre Original", "brand": "French Avenue", "gender": "Male/Unisex (leans masculine)", "season": "Fall, Winter", "notes": "Top - Incense, Guaiac Wood, Saffron / Heart - Leather, Amberwood, Violet, Sugar Cane / Base - Smoke, Patchouli, Sandalwood, Woodsy Notes, Black Musk", "category": ["Woody", "Leather", "Oriental", "Amber", "Smoky", "Creamy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Strawberries & Cream", "brand": "Royal Apothic", "gender": "Female", "season": "Spring, summer", "notes": "Top Notes: Raspberry and plum (or juicy brightness like strawberry, raspberry, apple, and nectarine)Heart / Middle Notes: Strawberry and whipped creamBase Notes: Sugar cubes, caramel, tonka vanilla, and soft amber", "category": ["Gourmand", "Fruity", "Sweet", "Vanilla", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Strawberry Tres Leches", "brand": "Arabiyat Sugar", "gender": "Female", "season": "Spring-Summer / year-round", "notes": "Top Notes: Strawberry, Milk, Nectarine, FreesiaHeart / Middle Notes: Marshmallow, Milk Candy, Caramel, Orange BlossomBase Notes: Vanilla, White Musk, Ambergris", "category": ["Gourmand", "Fruity", "Sweet", "Floral", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Sugar Crown", "brand": "Lattafa", "gender": "Female/Unisex", "season": "Fall-Winter", "notes": "Top Notes: Bitter orange, lemon, and candied fruitsMiddle Notes (Heart): Bubble gum, blueberry, peach, peach blossom, Bulgarian rose, ginger, and cinnamonBase Notes: Ambroxan, musk, and cedar", "category": ["Gourmand", "Sweet", "Spicy", "Citrus", "Amber", "Fruity"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Sugar Me Dulce De Leche", "brand": "Maison Alhambra", "gender": "Unisex/Female", "season": "Fall-Winter", "notes": "Dulce de leche / caramel-vanilla gourmand", "category": ["Gourmand", "Sweet", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Sugarcane Vanilla", "brand": "Arabiyat Prestige", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top Notes: Raspberry, Cherry, MandarinMiddle/Heart Notes: Lactones (milky/creamy notes), Vanilla, White FlowersBase Notes: Sandalwood, Musk", "category": ["Sweet", "Gourmand", "Fruity", "Floral", "Creamy", "Woody", "Citrus"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Supremacy Only Intense", "brand": "Afnan", "gender": "Male", "season": "Spring, autumn", "notes": "Top Notes: Black Currant, Bergamot, and AppleMiddle (Heart) Notes: Oakmoss, Patchouli, and LavenderBase Notes: Ambergris, Musk, and Saffron", "category": ["Woody", "Fruity", "Fresh", "Chypre", "Fougere", "Amber", "Oriental"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Sweet Surrender", "brand": "Mahajan", "gender": "Female", "season": "Fall-Winter / versatile", "notes": "Top Note: CaramelMiddle Notes: Coumarin (sweet, vanilla-like scent) and HoneyBase Notes: White Musk and Vanilla", "category": ["Gourmand", "Sweet", "Fougere", "Vanilla", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Sweet Surrender Pink Parfait", "brand": "Mahajan", "gender": "Female", "season": "Spring-Summer / year-round", "notes": "Top Notes: Graham Crackers, Marshmallow, Strawberry, Blackcurrant, and Chocolate (Strawberry S'mores)Middle (Heart) Notes: Marshmallow, Orange Blossom, and JasmineBase Notes: Vanilla, Whipped Cream, Sandalwood, Amber, and Musk", "category": ["Gourmand", "Fruity", "Sweet", "Floral", "Creamy", "Woody"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Tahira", "brand": "Riiffs", "gender": "Female", "season": "Spring , summer, fall", "notes": "Top Notes: Almond and Dragon fruitMiddle (Heart) Notes: Rose de Mai, Gardenia, and Praline (often listed as Rose de Mai and Gardenia with praline accents in the blend)Base Notes: Vanilla Absolute, Tonka Bean, and Patchouli", "category": ["Floral", "Oriental", "Gourmand", "Sweet", "Woody", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Taif", "brand": "Riiffs", "gender": "Unisex", "season": "Versatile (Spring-Summer preferred)", "notes": "Top - Ginger, Calabrian Bergamot, Lemon, Orange Blossom / Heart - Musk, Rose Petals, Tuberose / Base - Vanilla Bean, Amberwood, Clearwood", "category": ["Floral", "Fresh", "Woody", "Citrus", "Amber", "Chypre"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Teriaq", "brand": "Lattafa", "gender": "Unisex (leans feminine)", "season": "Fall, Winter", "notes": "Top - Caramel, Bitter Almond, Apricot, Pink Pepper / Heart - Honey, Rhubarb, White Flowers, Rose / Base - Leather, Vanilla, Musk, Vetiver, Labdanum", "category": ["Gourmand", "Floral", "Oriental", "Sweet", "Chypre", "Leather"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Teriaq Intense", "brand": "Lattafa", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Saffron, Bergamot / Heart - Plum Liquor, Cinnamon / Base - Amber, Tonka Bean, Benzoin", "category": ["Oriental", "Spicy", "Sweet", "Boozy", "Chypre", "Citrus"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "The King", "brand": "Ali", "gender": "Male", "season": "Fall-Winter / versatile", "notes": "Top Notes: Plum, Ozonic notes, Grapefruit, BergamotMiddle (Heart) Notes: Hazelnut, Honey, Cedar, Cashmere Wood, Orange Blossom, JasmineBase Notes: Amberwood, Patchouli, Oakmoss, Vetiver", "category": ["Woody", "Oriental", "Citrus", "Chypre", "Floral", "Amber"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Tiramisu Candy", "brand": "Rizz", "gender": "Female", "season": "Fall , winter", "notes": "Top Note: BergamotMiddle Notes: Black Currant, Strawberry, and MilkBase Notes: Musk and Vanilla", "category": ["Gourmand", "Fruity", "Sweet", "Citrus"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Tiramisu Coco", "brand": "Zimaya", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top Notes: Amaretto and CoffeeMiddle Notes: Ice cream, Biscuit, and VanillaBase Notes: Vanilla, Brown sugar, and Amber", "category": ["Gourmand", "Oriental", "Sweet", "Vanilla", "Amber", "Creamy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Toffee Ganache", "brand": "Arabiyat Sugar", "gender": "Unisex", "season": "Fall-Winter", "notes": "Top Notes: Hazelnut, Clove, Milk (or Vanilla Cream), and VanillaMiddle (Heart) Notes: Cinnamon, Toffee, and White FlowersBase Notes: Gourmand Accord, Milk, Biscuit (Speculoos/Biscoff), and Spices", "category": ["Gourmand", "Sweet", "Spicy", "Creamy", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Tubbees Tres Leches", "brand": "Grandeur", "gender": "Unisex", "season": "Fall, winter", "notes": "Top Notes: Vanilla bean, cold milk accord, sweet notes, spicy notes, and caramelMiddle Notes (Heart): Milk, chocolate, and floral notes", "category": ["Gourmand", "Sweet", "Vanilla", "Creamy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Vanilla", "brand": "Bellavita", "gender": "Female", "season": "Fall, Winter", "notes": "Top - Aldehydes, Heliotrope, Coconut, Vanilla / Heart - Vanilla, Mango / Base - White Musk, Coconut, Vanilla Absolute", "category": ["Gourmand", "Sweet", "Fruity", "Floral", "Powdery"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Vanilla Addiction", "brand": "Gulf Orchid", "gender": "Unisex/Female", "season": "Fall-Winter", "notes": "Top Notes: Coconut, Lavender, and Lily of the ValleyHeart (Middle) Notes: Tonka Bean, Jasmine, Rose, and PatchouliBase Notes: Vanilla, Amber, and Musk", "category": ["Gourmand", "Sweet", "Floral", "Aromatic", "Fougere", "Fruity"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Vanilla Aura", "brand": "Maison Asrar", "gender": "Female/Unisex", "season": "Fall, Winter", "notes": "Top - Vanilla / Heart - Creamy Sweet / Base - Vanilla, Musk", "category": ["Gourmand", "Sweet", "Creamy", "Vanilla", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Vanilla Ayelet", "brand": "Khayali", "gender": "Unisex", "season": "Fall-Winter", "notes": "Vanilla orchid, jasmine / Brown sugar, tonka / Amber, musk, patchouli (Kayali-inspired)", "category": ["Gourmand", "Floral", "Sweet", "Vanilla", "Woody"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Vanilla Cream Macaron", "brand": "Arabiyat Sugar", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top Note: Ripe BananaMiddle Note: Chantilly CreamBase Note: Custard Sauce (or Vanilla/Vanilla Musk)", "category": ["Gourmand", "Fruity", "Sweet", "Vanilla", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Vanilla Dunes", "brand": "Khadlaj", "gender": "Unisex", "season": "Autumn, Winter", "notes": "Top - Vanilla, Cinnamon, Cardamom, Bergamot / Heart - Orange Blossom, Guaiac Wood, Bourbon / Base - Praline, Amber, Musk", "category": ["Gourmand", "Spicy", "Woody", "Citrus", "Sweet"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Vanilla Freak (Give Me Gourmand)", "brand": "Lattafa", "gender": "Unisex / Female-leaning", "season": "Fall, Spring", "notes": "Top - Cupcake / Heart - Sugar Frosting, Almond, Cinnamon / Base - Butter, Vanilla, Musk", "category": ["Gourmand", "Sweet", "Creamy", "Spicy", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Vanilla Madness", "brand": "Mamlakat Al Oud", "gender": "Unisex (leans feminine)", "season": "Fall, Winter (versatile year-round)", "notes": "Top - Vanilla (woody tones), Lavender, Cacao, Ginger / Heart - Vanilla Caviar / Base - Vanilla Absolute", "category": ["Gourmand", "Sweet", "Aromatic", "Fougere", "Spicy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Vanilla Milkshake", "brand": "Snack House", "gender": "Unisex", "season": "Fall, winter", "notes": "Top Notes: Vanilla Orchid and JasmineMiddle (Heart) Notes: Brown Sugar and Tonka BeanBase Notes: Amber, Amberwood, Musk, and Patchouli", "category": ["Gourmand", "Oriental", "Floral", "Amber", "Sweet", "Woody"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Vanilla Musk", "brand": "NatureWell", "gender": "Unisex", "season": "Fall, winter", "notes": "Top Notes: Sugared Petals & Mandarin MuskMid Notes: Vanilla Cream & SpiceBase Notes: Sleek Woods & Tonka", "category": ["Gourmand", "Sweet", "Citrus", "Vanilla", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Vanilla Seduction", "brand": "Maison Asrar", "gender": "Female/Unisex", "season": "Fall, Winter", "notes": "Top - Plum, Jasmine, Lily of the Valley / Heart - Vanilla, Brown Sugar, Caramel / Base - Tonka, Patchouli, Amber, Musk", "category": ["Gourmand", "Floral", "Sweet", "Vanilla", "Woody"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Vanilla Skin", "brand": "Phlur", "gender": "Unisex (female-leaning)", "season": "Fall, Winter", "notes": "Top - Sugar, Pink Pepper, Apple / Heart - Cashmere Wood, Jasmine, Lily / Base - Vanilla, Sandalwood, Agarwood, Benzoin", "category": ["Gourmand", "Woody", "Sweet", "Floral", "Oud"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Velvet Breeze", "brand": "Mamlakat Al Oud", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Italian Bergamot, Pistachio Gelato, Hazelnut, Sweet Rum, Cardamom / Heart - Geranium, White Peony, Muguet, Jasmine / Base - Amber, Musk, Woody Notes", "category": ["Gourmand", "Floral", "Woody", "Chypre", "Citrus", "Spicy"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Vulcan Baie", "brand": "French Avenue", "gender": "Unisex", "season": "Spring, Summer", "notes": "Top - Blackberry, Black Currant, Rosemary, Bergamot / Heart - Raspberry, Vodka, Basil, Lily of the Valley / Base - Strawberry, Musk, Peach, Amber, Sandalwood, Patchouli, Incense", "category": ["Fruity", "Fresh", "Aromatic", "Woody", "Oriental", "Chypre"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Whipped Pleasure (Give Me Gourmand)", "brand": "Lattafa", "gender": "Female", "season": "Fall, Winter", "notes": "Top - Caramel, Popcorn, Salted Caramel / Heart - Milk, Jasmine / Base - Tonka, Benzoin, Musk, Ambrofix", "category": ["Gourmand", "Sweet", "Floral", "Oriental", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Yara Candy Body Spray", "brand": "Lattafa", "gender": "Female", "season": "Fall, Winter", "notes": "Top - Candy, Sweet / Heart - Fruity / Base - Vanilla, Musk", "category": ["Gourmand", "Sweet", "Fruity", "Vanilla", "Animalic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Yara Elixir", "brand": "Lattafa", "gender": "Female", "season": "Fall, Winter, Cool Spring Days", "notes": "Top - Strawberry S'mores, Black Currant / Heart - Jasmine, Orange Blossom / Base - Vanilla, Caramel, Amber, Musk", "category": ["Gourmand", "Floral", "Sweet", "Fruity", "Citrus"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Yara Original", "brand": "Lattafa", "gender": "Female", "season": "Spring-Summer", "notes": "Top - Orchid, heliotrope, tangerine / Heart - Gourmand accord, tropical fruits / Base - Vanilla, musk, sandalwood", "category": ["Floral", "Gourmand", "Fruity", "Woody", "Creamy", "Powdery"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Yara Tous", "brand": "Lattafa", "gender": "Female", "season": "Summer", "notes": "Top Notes: Mango, coconut, passion fruitMiddle Notes: Jasmine, orange blossom, heliotropeBase Notes: Vanilla, cashmeran, musk", "category": ["Floral", "Fruity", "Sweet", "Gourmand", "Citrus", "Powdery"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Zainab Oil", "brand": "Khadlaj", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top - Bergamot, Gardenia, Almond / Heart - Coconut, Caramel / Base - Patchouli, Vanilla, Musk", "category": ["Gourmand", "Floral", "Sweet", "Chypre", "Citrus"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Zenith", "brand": "Riiffs", "gender": "Unisex", "season": "Spring, summer, winter", "notes": "Top Notes: Coconut, Vanilla, Creamy AccordsHeart (Middle) Notes: Fruity Notes, Jasmine, Powdery AccordsBase Notes: Vanilla, Musk, Woody Notes", "category": ["Gourmand", "Sweet", "Powdery", "Fruity", "Creamy", "Floral"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Zukhruf Pink", "brand": "Zimaya", "gender": "Unisex", "season": "Winter", "notes": "Top Notes: Orchid, Heliotrope, and VanillaHeart (Middle) Notes: Musk, Marshmallow, and Almond MilkBase Notes: Amber, Vanilla, and Sandalwood", "category": ["Gourmand", "Floral", "Creamy", "Woody", "Powdery"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Victoria", "brand": "Lattafa", "gender": "Unisex", "season": "Spring, summer ", "notes": "Top Notes: Lemon Meringue Pie (offering a bright, zesty, and sweet citrus opening)Middle (Heart) Notes: Neroli (lending a delicate, sophisticated, and clean floral touch)Base Notes: Vanilla (providing a smooth, creamy, and comforting warm finish)", "category": ["Gourmand", "Floral", "Fruity", "Citrus", "Creamy", "Sweet", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": "EDP"}, {"name": "Qimmah", "brand": "Lattafa", "gender": "Female", "season": "Fall, Winter", "notes": "Top Notes: Almond, CoffeeHeart (Middle) Notes: Jasmine, Tuberose, Tonka BeanBase Notes: Vanilla, Cacao, Sandalwood", "category": ["Gourmand", "Floral", "Woody", "Creamy", "Sweet"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": "EDP"}, {"name": "Tiramisu S'mores", "brand": "Zimaya", "gender": "Female", "season": "Fall, Winter", "notes": "Top Notes: Marshmallow, Chocolate, Coffee, Bergamot, and Nectarine Blossom.Middle (Heart) Notes: Biscuit, Vanilla, Milk, Almond, and Musk.Base Notes: Sugar, Caramel, Creamy Notes, Amber, and Musk.", "category": ["Gourmand", "Sweet", "Creamy", "Chypre", "Citrus"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Tiramisu caramel", "brand": "Zimaya", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top Note: CaramelMiddle (Heart) Notes: Honey, Coumarin, and Woody NotesBase Notes: Vanilla, Whiskey, and Musk", "category": ["Gourmand", "Sweet", "Boozy", "Fougere", "Vanilla"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": ""}, {"name": "Orhan", "brand": "Nusuk", "gender": "Unisex", "season": "Fall, Winter", "notes": "Top Notes: Blackberry, BlueberryMiddle Notes: Freesia, Lavender, RoseBase Notes: Vanilla, Raspberry, Oakmoss, Patchouli", "category": ["Gourmand", "Fougere", "Floral", "Fruity", "Woody", "Aromatic"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": "EDP"}, {"name": "Nisma", "brand": "Arabiyat prestige", "gender": "Female", "season": "Summer, spring", "notes": "Top Notes: Pistachio, Hazelnut, and Cassis (Blackcurrant bud)Middle (Heart) Notes: Raspberry, Lily of the Valley, Jasmine, and PeonyBase Notes: Sandalwood, Vanilla, Tonka Bean, Maltol, and Lactonic notes", "category": ["Gourmand", "Fruity", "Creamy", "Floral", "Woody"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": "EDP"}, {"name": "Lady glamour", "brand": "Arabiyat prestige", "gender": "Female", "season": "Spring, summer ", "notes": "Top Notes: BergamotMiddle (Heart) Notes: Orange, Limonene, and RoseBase Notes: Coconut, Vanilla, White Musk, Dry Wood, and Gourmand notes", "category": ["Gourmand", "Citrus", "Chypre", "Fruity", "Sweet"], "dupe_of": "", "shelf_status": "Own", "size_ml": None, "concentration": "EDP"}]
...
def matches_gender(fragrance: dict, preferred: str) -> bool:
    if preferred == "Any":
        return True
    fg = normalize_gender(fragrance.get("gender") or "")
    if preferred == "Male":
...
def fetch_live_temp_f(lat: float = None, lon: float = None, label: str = None, force: bool = False) -> dict:
    ...
    def _pack(temp_f, source, observed="", extra=None):
        temp_f = float(temp_f)
        if temp_f < -40 or temp_f > 140:
            return {"ok": False, "detail": f"Implausible reading {temp_f} F", "label": label}
        temp_i = int(round(temp_f))
        band = temp_f_to_band(temp_i)
        detail = f"{label} | {temp_i} F | {band} | {source}"
        if observed:
...
def top_picks_for_calendar_season(season_name: str, gender: str = "Any", top_n: int = 5) -> list:
    ...
    band = band_map.get(season_name, "Any")
    ...
    for f in st.session_state.get("fragrances_db") or []:
        ...
        if st.session_state.get("user_reactions", {}).get(f.get("name")) == "fav":
            pts += 15.0
        # light category bonus for season-typical families
        cats = set(f.get("category") or [])
        if season_name == "summer" and cats & {"Fresh", "Citrus", "Aquatic", "Fruity"}:
            pts += 8.0
        if season_name == "winter" and cats & {"Gourmand", "Oriental", "Woody", "Spicy", "Vanilla"}:
            pts += 8.0
        if season_name == "spring" and cats & {"Floral", "Fresh", "Green", "Fruity"}:
            pts += 8.0
        if season_name in ("fall", "autumn") and cats & {"Woody", "Spicy", "Oriental", "Gourmand"}:
            pts += 8.0
        scored.append((pts, f))
    ...
    for pts, f in scored:
        ...
        if brand and brand in used and len(out) < top_n:
            continue
        if brand:
            used.add(brand)
        out.append(f)
...
with st.sidebar:
    ...
    with st.expander("Recommend", expanded=True):
        ...
        if st.session_state.pop("_apply_live_temp", False):
            live = st.session_state.get("live_temp_meta") or {}
            if live.get("ok") and live.get("temp_f") is not None:
                st.session_state["temp_search_f"] = int(round(float(live["temp_f"])))
        if st.session_state.pop("_reset_temp_search", False):
            try:
        ...
        if _live.get("ok"):
            _src = str(_live.get("source") or "weather")
            _fc = str(_live.get("short_forecast") or "")
            st.success(
                "Live: **"
        ...
        if _live_err:
            st.warning("Live temp unavailable - using the slider value.")

        # Force recommend path to use this temp
        st.session_state["filter_use_temp"] = True
        st.session_state["filter_weather"] = "Any"
        st.session_state["temp_search_gender"] = gender
        ...
        categories = st.multiselect(
            ...
            help="Leave empty for any category.",
        )
...
with tab_discover:
    ...
    with st.expander("Top 5 by season", expanded=True):
        ...
        with gcol:
            ts_gender = st.selectbox(
                "Gender",
                ["Any", "Female", "Male", "Unisex"],
                key="top_season_gender",
            )
        with scol:
            ts_season = st.selectbox(
                "Season",
                ["All seasons"] + season_labels,
                key="top_season_pick",
            )
        ...
        if show_top or refresh_top:
            ...
            if refresh_top:
                import time as _time
                shuffle_salt = str(_time.time())
            if ts_season == "All seasons":
                targets = seasons
            else:
                targets = [(ts_season, season_key_map[ts_season])]
            results = {}
            for label, key in targets:
                picks = top_picks_for_calendar_season(
                    key, gender=ts_gender, top_n=5
                )
                # Refresh: rotate order with light shuffle while keeping top pool
                if refresh_top and picks and len(picks) > 1:
                    pool = top_picks_for_calendar_season(
                        key, gender=ts_gender, top_n=12
                    )
                    if pool:
                        random.shuffle(pool)
                        # re-apply brand diversity after shuffle
                        out, used = [], set()
                        for f in pool:
                            brand = (f.get("brand") or "").lower()
                            if brand and brand in used and len(out) < 5:
                                continue
                            if brand:
                                used.add(brand)
                            out.append(f)
            ...
            st.session_state["_top_season_gender_used"] = ts_gender
            st.session_state["_top_season_pick_used"] = ts_season

        results = st.session_state.get("_top_season_results")
        if results:
            st.caption(
                "Gender: **"
                + str(st.session_state.get("_top_season_gender_used") or ts_gender)
                + "** | Season: **"
            ...
            for label in season_labels:
                ...
                if not picks:
                    ...
                    for i, f in enumerate(picks, 1):
                        ...
                        if f.get("notes"):
                            st.caption(str(f.get("notes"))[:140])
                        c1, c2 = st.columns(2)
                        with c1:
                            if st.button(
                                "Log SOTD",
    ...
    if last_recs is not None and (last_recs.get("selected") or []):
...
with tab_layer:
    ...
    if ev:
        ...
        if _sci is not None:
            if _sci < 75:
                _tone = "Weak (under 75) - not recommended"
            else:
                _tone = "Good (75+) - solid layer"
            st.caption(
                "Match score: **"
                + str(_sci)
                + "/100** - "
        ...
        if steps:
            ...
            if app.get("order_names"):
                st.success(
                    "Spray order: " + clean_display_text(" > ".join([str(x) for x in (app.get("order_names") or [])]))
                )
...
with tab_vault:
    ...
    with st.expander("Season helper", expanded=True):
        ...
        def _weak_season(s):
            ...
            if not s:
                return True
            if low in ("versatile", "any", "n/a", "na", "none", "all", "?"):
                return True
            if len(s) < 3:
                return True
            return False
        ...
        weak = []
        for i, f in enumerate(db):
            if _weak_season(f.get("season")):
                sug = suggest_seasons_from_notes(
                    f.get("notes") or "", f.get("category") or []
                )
                weak.append(
                    {
                        "idx": i,
        ...
        st.write(
            "**"
            + str(len(weak))
            + "** bottle(s) with empty / Versatile / vague season tags."
        )

        sh_mode = st.radio(
            "How do you want to fix seasons?",
            ["Pick one bottle", "Review & fix all weak"],
            key="season_helper_mode",
            horizontal=True,
        )

        if sh_mode == "Pick one bottle":
            names = sorted((f.get("name") or "") for f in db if f.get("name"))
            bottle = st.selectbox(
                "Bottle", ["- select -"] + names, key="season_check_bottle"
            )
            if bottle and bottle != "- select -":
                frag = next((f for f in db if f.get("name") == bottle), None)
                if frag:
                    cur = frag.get("season") or "none"
                    suggested = suggest_seasons_from_notes(
                        frag.get("notes") or "",
                        frag.get("category") or [],
                    )
                    pick = suggested[0] if suggested else "Versatile"
                    st.info(
                        "Current: **"
                        + clean_display_text(cur)
                        + "**  \nSuggested: **"
                        + clean_display_text(pick)
                        + "**"
                    )
                    options = [pick] + [x for x in SEASON_CHOICES if x != pick]
                    ...
                    if st.button("Save season", type="primary", key="season_apply_one"):
                        ...
                        mark_vault_dirty()
                        save_persisted_data()
                        st.success("Saved **" + bottle + "** > " + new_season)
                        st.rerun()
        else:
            if not weak:
                st.success("No weak season tags - vault looks good.")
            else:
                st.caption("Preview (first 25). Suggested from notes + categories.")
                for item in weak[:25]:
                    st.markdown(
                        "**"
                        + clean_display_text(item.get("name"))
                        + "** (*"
                        + clean_display_text(item.get("brand"))
                        + "*)  \n"
                        + "Now: "
                        + clean_display_text(item.get("current"))
                        + " > **"
                        + clean_display_text(item.get("suggested"))
                        + "**"
                    )
                if len(weak) > 25:
                    st.caption("...and " + str(len(weak) - 25) + " more")
                if st.button(
                    "Apply all suggested seasons (" + str(len(weak)) + ")",
                    type="primary",
                    ...
                    for item in weak:
                        i = item["idx"]
                        st.session_state["fragrances_db"][i]["season"] = item["suggested"]
                        fixed += 1
                    if fixed:
                        try:
                            log_vault_action(
                                "edited", str(fixed) + " bottles", "season-helper-bulk"
                            )
                        except Exception:
                            pass
                        mark_vault_dirty()
    ...
    with st.expander("Backup & restore", expanded=True):
        if st.button("Restore full sanctuary seed (183 bottles)", key="restore_sanctuary_seed"):
            st.session_state["fragrances_db"] = list(SANCTUARY_SEED_DB)
            mark_vault_dirty()
            save_persisted_data(force=True)
            st.success("Restored **183** sanctuary bottles. Export JSON and keep a copy.")
            st.rerun()
