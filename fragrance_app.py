...
if "fragrances_db" not in st.session_state:
    if _persisted.get("fragrances_db"):
        ...
        # === CLEANED SEED (177 bottles) Ã¢ÂÂ matches organized vault ===
...
def layer_note_reasons(f1: dict, f2: dict) -> list:
    ...
    for family, pts in _NOTE_SYNERGY:
        ...
        if a and b:
            reasons.append(
                f"Synergy ({', '.join(list(family)[:3])}ÃÂÃÂ¦): "
...
CHALLENGE_DECK = [
    ...
    "No gourmands today Ã¢ÂÂ go dry, green, woody or citrus.",
    "Pick something with coffee, chocolate or caramel.",
    "Horror night: only smoky, incense, leather or dark woody.",
    "One spray only Ã¢ÂÂ see if it still projects on you.",
    "Wear your softest, skin-scent style bottle all day.",
    "Match the weather outside right now (hot Ã¢ÂÂ fresh, cold Ã¢ÂÂ cozy).",
    ...
    "Office-safe only Ã¢ÂÂ nothing loud or sweet.",
