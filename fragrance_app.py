...
.stApp {
    ...
    background-image:
        linear-gradient(180deg, rgba(3, 6, 12, 0.90) 0%, rgba(4, 8, 16, 0.86) 45%, rgba(2, 4, 8, 0.93) 100%),
...
/* Readable panels over patterned bg */
section[data-testid="stSidebar"] {
    background: linear-gradient(180deg, rgba(4, 8, 16, 0.96) 0%, rgba(3, 5, 10, 0.98) 100%) !important;
}
...
.sdg-hero {
    background:
        radial-gradient(ellipse at 15% 0%, rgba(50, 100, 180, 0.18), transparent 55%),
        linear-gradient(180deg, rgba(10, 16, 28, 0.92) 0%, rgba(4, 7, 14, 0.95) 100%) !important;
}
